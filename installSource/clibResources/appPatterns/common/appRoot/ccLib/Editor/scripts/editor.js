...
//	var a = '/n end of LoadHTML';
//	for(var i=0;i<arrStyle.length;i++) {
//		if(arrStyle[i][0].indexOf('cc')>0){
//			a+=arrStyle[i][0];
//			if(arrStyle[i][1]) {
//				a+=',true'
//			} else {
...
function openStyleSelect()
	...
	for(var i=0;i<arrStyle.length;i++)
		{
		sSelector=arrStyle[i][0];
		var isOnSelection=arrStyle[i][1];
...
// ccBodyPrint is OK - false
// but called 15 times??
//	var arrStyle=this.arrStyle;
//	var a = '/n start of replaceTags';
//	for(var i=0;i<arrStyle.length;i++) {
//		if(arrStyle[i][0].indexOf('cc')>0){
//			a+=arrStyle[i][0];
//			if(arrStyle[i][1]) {
...
function hide()
	...
	if(this.btnPreview)eval("dropPreview"+this.oName).style.display="none";
          if(this.btnTextFormatting||this.btnParagraphFormatting||this.btnListFormatting||this.btnBoxFormatting||this.btnCssText||this.btnCssBuilder) var d=document.getElementById("dropStyle"+this.oName);if(d){d.style.display="none"};
