...
namespace Contensive.Processor.Models.Db {
    public class DownloadModel : BaseModel {
        ...
        public static DownloadModel add(CoreController core) {
            return add<DownloadModel>(core);
        }
        //
        //====================================================================================================
        public static DownloadModel add(CoreController core, ref List<string> callersCacheNameList) {
            return add<DownloadModel>(core, ref callersCacheNameList);
        }
        //
        //====================================================================================================
        ...
        //
        //====================================================================================================
        public static DownloadModel createByName(CoreController core, string recordName) {
            return createByName<DownloadModel>(core, recordName);
        }
        //
        //====================================================================================================
        public static DownloadModel createByName(CoreController core, string recordName, ref List<string> callersCacheNameList) {
            return createByName<DownloadModel>(core, recordName, ref callersCacheNameList);
        }
        //
        //====================================================================================================
