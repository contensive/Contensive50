...
//                string MenuFlyoutIcon = core.siteProperties.getText("MenuFlyoutIcon", DefaultIcon);
//                switch (MenuStyle) {
//                    case 11:
...
//            try {
//                if ((!string.IsNullOrEmpty(name)) && ((UsedEntries + ",").IndexOf("," + name.ToLowerInvariant() + ",")  == -1)) {
//                    UsedEntries = UsedEntries + "," + name.ToLowerInvariant();
