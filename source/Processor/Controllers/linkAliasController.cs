            ...
            try {
                ...
                if (!string.IsNullOrEmpty(WorkingLinkAlias)) {
                    ...
                    if (!string.IsNullOrEmpty(WorkingLinkAlias)) {
                        ...
                        } else if (core.fileAppRoot.pathExists(core.appConfig.localWwwPath + "\\" + WorkingLinkAlias.Substring(1))) {
                                        ...
                                        if (OverRideDuplicate) {
                                            ...
                                            if (DupCausesWarning) {
                                                if (LinkAliasPageID == 0) {
                                                    int PageContentCID = Models.Domain.MetaModel.getContentId(core, "Page Content");
                                                    return_WarningMessage = ""
