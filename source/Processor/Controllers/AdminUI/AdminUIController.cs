...
namespace Contensive.Processor.Controllers {
    ...
    public static class AdminUIController {
        ...
        /// <returns></returns>
        public static string getDefaultEditor_bool(CoreController core, string htmlName, bool htmlValue, bool readOnly, string htmlId, bool required = false) {
        ...
        /// <returns></returns>
        public static string getDefaultEditor_text(CoreController core, string fieldName, string fieldValue, bool readOnly, string htmlId, bool required = false) {
        ...
        /// <param name="isPassword"></param>
        /// <returns></returns>
        public static string getDefaultEditor_TextArea(CoreController core, string fieldName, string fieldValue, bool readOnly, string htmlId, bool required=false) {
            //
        ...
        public static string getDefaultEditor_TextArea(CoreController core, string fieldName, string fieldValue, bool readOnly)
            => getDefaultEditor_TextArea(core, fieldName, fieldValue, readOnly, "",false);
        //
        // ====================================================================================================
        //
        public static string getDefaultEditor_Html(CoreController core, string fieldName, string fieldValue, string editorAddonListJSON, string styleList, string styleOptionList, bool readOnly, string htmlId) {
            ...
            if (readOnly) {
                ...
                result += getDefaultEditor_TextArea(core, fieldName, fieldValue, readOnly, htmlId,false);
                return result;
            }
        ...
        public static string getDefaultEditor_lookupContent(CoreController core, string fieldName, int fieldValue, int lookupContentId, ref bool IsEmptyList, bool readOnly, string htmlId, string WhyReadOnlyMsg, bool fieldRequired, string sqlFilter) {
            ...
            return getDefaultEditor_lookupContent(core, fieldName, fieldValue, lookupContentMetacontent, ref IsEmptyList, readOnly, htmlId, WhyReadOnlyMsg, fieldRequired, sqlFilter);
        }

        public static string getDefaultEditor_lookupContent(CoreController core, string fieldName, int fieldValue, string lookupContentName, ref bool IsEmptyList, bool readOnly, string htmlId, string WhyReadOnlyMsg, bool fieldRequired, string sqlFilter) {
        ...
        public static string getDefaultEditor_lookupContent(CoreController core, string fieldName, int fieldValue, ContentMetadataModel lookupContentMetacontent, ref bool IsEmptyList, bool readOnly, string htmlId, string WhyReadOnlyMsg, bool fieldRequired, string sqlFilter) {
            string result = "";
            if (lookupContentMetacontent == null) {
