...
//					UcaseTargetKey = Key.ToUpper().Replace(Environment.NewLine, "");
//					LowGuess = -1;
...
//				test = "";
//				//
//				UcaseKey = Key.ToUpper().Replace(Environment.NewLine, "");
//				//UcaseKey = UCase(Key)
...
//					}
//					store.ArrayPointer = store.ArrayPointer + 1;
//					returnKey = common.kmaEncodeInteger(store.PointerArray[store.ArrayPointer]);
//				}
//			} catch (Exception ex) {
...
//				string keyToSave;
//				//
//				keyToSave = Key.ToUpper().Replace(Environment.NewLine, "");
//				//
...
//						nextPointerMatch = common.kmaEncodeInteger(store.PointerArray[store.ArrayPointer]);
//					} else {
//						store.ArrayPointer = store.ArrayPointer - 1;
//					}
//				}
...
//					firstPointer = common.kmaEncodeInteger(store.PointerArray[store.ArrayPointer]);
//				}
//				//
//			} catch (Exception ex) {
...
//					store.ArrayPointer = store.ArrayPointer + 1;
//					nextPointer = common.kmaEncodeInteger(store.PointerArray[store.ArrayPointer]);
//				}
//			} catch (Exception ex) {
//				throw new indexException("GetPointer error", ex);
//			}
...
//				Low = First;
//				High = Last;
//				MidValue = C[(First + Last) / 2].ToString();
//				//
//				do {
