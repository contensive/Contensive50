        ...
        public static string GetForm_Root(CoreController core) {
            ...
            try {
                ...
                if (string.IsNullOrEmpty(returnHtml)) {
                    ...
                    + Environment.NewLine + "<div><a href=http://www.Contensive.com target=_blank><img style=\"border:1px solid #000;\" src=\"https://s3.amazonaws.com/cdn.contensive.com/assets/20190729/images/ContensiveAdminLogo.GIF\" border=0 ></A></div>"
