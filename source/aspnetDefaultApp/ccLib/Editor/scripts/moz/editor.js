...
function RENDER(sPreloadHTML)
	...
	document.write("<iframe tabIndex='-1' style='width:1px;height:1px;overflow:auto;border:0px' id=\"myStyle"+this.oName+"\" name=\"myStyle"+this.oName+"\" src='"+this.scriptPath+"blank.gif'></iframe>");
...
function hide()
    ...
    if(this.btnTextFormatting||this.btnParagraphFormatting||this.btnListFormating||this.btnBoxFormatting||this.btnCssText||this.btnCssBuilder) var d=document.getElementById("dropStyle"+this.oName);if(d){d.style.display="none"};
...
// when bCancel is true, the 'Cancel' condition prevents the floyout menu from working
        //bCancel=true;
        }
...
function doUp(btn)//return true/false
    {
// when bCancel is true, the function exits with false, preventing the dropShow from displaying the Add-on menu
    if(bCancel)
        {
        //lagi pushed tapi mouseout (cancel)
        bCancel=false;btn.style.top=(0+iconOffsetTop)+"px";
