...
namespace integrationTests {
    ...
    public class cpContentTests {
        ...
        /// </summary>
        [TestMethod()]
        public void cpContentAddRecordTest() {
            // arrange
        ...
        /// </summary>
        [TestMethod()]
        public void cpContentDeleteRecordTest() {
            // arrange
            CPClass cp = new CPClass("testapp");
            CPCSBaseClass cs = cp.CSNew();
        ...
        /// </summary>
        [TestMethod()]
        public void cpContentGetCopyTest() {
            // arrange
            CPClass cp = new CPClass("testapp");
            CPCSBaseClass cs = cp.CSNew();
            int recordId = 0;
        ...
        /// </summary>
        [TestMethod()]
        public void cpContentGetCopyWithDefaultTest() {
            // arrange
            CPClass cp = new CPClass("testapp");
            CPCSBaseClass cs = cp.CSNew();
            string testCopy = "test copy " + cp.Utils.GetRandomInteger().ToString();
        ...
        /// </summary>
        [TestMethod()]
        public void cpContentSetCopyTest() {
            // arrange
            CPClass cp = new CPClass("testapp");
        ...
        /// </summary>
        [TestMethod()]
        public void cpContentAddContentTest() {
            // arrange
            CPClass cp = new CPClass("testapp");
            CPCSBaseClass cs = cp.CSNew();
        ...
        /// </summary>
        [TestMethod()]
        public void cpContentAddContentFieldTest() {
            // arrange
            CPClass cp = new CPClass("testapp");
            CPCSBaseClass cs = cp.CSNew();
            int recordId = 0;
