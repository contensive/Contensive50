...
namespace integrationTests {
    ...
    public class cpCacheTests {
        ...
        /// </summary>
        [TestMethod()]
        public void cpCacheLegacySaveRead() {
            // arrange
        ...
        /// </summary>
        [TestMethod()]
        public void cpCacheSetGet_integration() {
            // arrange
            CPClass cp = new CPClass("testapp");
        ...
        /// </summary>
        [TestMethod()]
        public void cpCacheInvalidateAll_integration() {
            // arrange
            CPClass cp = new CPClass("testapp");
            DateTime testDate = new DateTime(1990, 8, 7);
            cp.core.siteProperties.setProperty("AllowBake", true);
        ...
        /// </summary>
        [TestMethod()]
        public void cpCacheInvalidateList_integration() {
            // arrange
            CPClass cp = new CPClass("testapp");
            cp.core.siteProperties.setProperty("AllowBake", true);
            DateTime testDate = new DateTime(1990, 8, 7);
        ...
        /// </summary>
        [TestMethod()]
        public void cpCacheInvalidationOnEdit_integration() {
            // arrange
            CPClass cp = new CPClass("testapp");
            cp.core.siteProperties.setProperty("AllowBake", true);
        ...
        /// </summary>
        [TestMethod()]
        public void cpCacheTagInvalidationString() {
            // arrange
            CPClass cp = new CPClass("testapp");
            cp.core.siteProperties.setProperty("AllowBake", true);
            // act
