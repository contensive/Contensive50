...
'        '            _localClusterFiles = New coreFileSystemClass(cpCore, cpCore.serverConfig.isLocal, coreFileSystemClass.fileSyncModeEnum.activeSync, cpCore.serverConfig.clusterPath)
'        '        End If
...
'        '====================================================================================================
'        ''' <summary>
'        ''' save config changes to the config.json file
'        ''' </summary>
'        Public Sub saveConfig()
'            Dim jsonTemp As String = cpCore.json.Serialize(cpCore.serverConfig)
