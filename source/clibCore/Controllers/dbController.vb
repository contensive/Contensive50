...
Namespace Contensive.Core.Controllers
    Public Class dbController
        ...
        Public Function cs_openSql(ByVal SQL As String, Optional ByVal DataSourceName As String = "", Optional ByVal PageSize As Integer = 9999, Optional ByVal PageNumber As Integer = 1) As Integer
            Dim returnCs As Integer = -1
            Try
                returnCs = cs_init(cpcore.authContext.authContextUser.id)
                With contentSetStore(returnCs)
                    .Updateable = False
                    .ContentName = ""
                    .PageNumber = PageNumber
        ...
        Public Function cs_insertRecord(ByVal ContentName As String, Optional ByVal MemberID As Integer = -1) As Integer
            ...
            Try
                ...
                Else
                    ...
                    Else
                        If MemberID = -1 Then
                            MemberID = cpcore.authContext.authContextUser.id
                        End If
                        With CDef
        ...
        Public Sub createContentFromSQLTable(ByVal DataSourceName As String, ByVal TableName As String, ByVal ContentName As String)
            Try
                ...
                If dt.Rows.Count = 0 Then
                    ...
                    '
                    dt = cpCore.db.insertTableRecordGetDataTable(DataSourceName, TableName, cpcore.authContext.authContextUser.id)
                    If dt.Rows.Count > 0 Then
