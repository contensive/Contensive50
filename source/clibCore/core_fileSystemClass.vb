...
Namespace Contensive.Core
    ...
    Public Class fileSystemClass
        ...
        '========================================================================
        '
        Public Sub copyFile(ByVal srcPathFilename As String, ByVal dstPathFilename As String, Optional dstFileSystem As fileSystemClass = Nothing)
            Try
        ...
        ' copy one folder to another, include subfolders
        '
        Public Sub copyFolder(ByVal srcPath As String, ByVal dstPath As String, Optional dstFileSystem As fileSystemClass = Nothing)
            Try
                If Not clusterConfig.isLocal Then
                    '
                    ' s3
