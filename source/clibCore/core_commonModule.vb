...
Namespace Contensive.Core
    ...
    Public Module ccCommonModule
        ...
        Public Function modifyLinkQuery(ByVal Link As String, ByVal QueryName As String, ByVal QueryValue As String, Optional ByVal AddIfMissing As Boolean = True) As String
            ...
            '
            iAddIfMissing = encodeEmptyBoolean(AddIfMissing, True)
        ...
        Public Const TestPointTabChr As Char = "-"
        ...
        Public Function EncodeSQL(ByVal expression As Object, Optional ByVal fieldType As Integer = FieldTypeIdText) As String
            ...
            '
            iFieldType = encodeEmptyInteger(fieldType, FieldTypeIdText)
            Select Case iFieldType
                Case FieldTypeIdBoolean
                    EncodeSQL = EncodeSQLBoolean(expression)
                Case FieldTypeIdCurrency, FieldTypeIdAutoIdIncrement, FieldTypeIdFloat, FieldTypeIdInteger, FieldTypeIdLookup, FieldTypeIdMemberSelect
                    EncodeSQL = EncodeSQLNumber(expression)
        ...
        Public Function processReplacement(ByVal NameValueLines As Object, ByVal Source As Object) As String
            ...
            If PairCnt > 0 Then
                For PairPtr = 0 To PairCnt - 1
                    processReplacement = Replace(processReplacement, Names(PairPtr), Values(PairPtr), 1, 999, 1)
                Next
            End If
            '
        End Function
...
ErrorTrap:
        ...
        '
        '
        Public Function GetHTMLComment(ByVal Comment) As String
        ...
        Public Function DecodeGMTDate(ByVal GMTDate As String) As Date
            ...
            If GMTDate <> "" Then
                HourPart = Mid(GMTDate, 6, 11)
                If IsDate(HourPart) Then
                    YearPart = Mid(GMTDate, 18, 8)
...
ErrorTrap:
        ...
        Public Function GetIntegerString(ByVal Value As Integer, ByVal DigitCount As Integer) As String
            If Len(Value) <= DigitCount Then
                GetIntegerString = New String("0", DigitCount - Len(CStr(Value))) & CStr(Value)
            Else
                GetIntegerString = CStr(Value)
            End If
        End Function
        ...
        '==========================================================================================
        '
        Public Function GetErrString(Optional ByVal ErrorObject As Object = Nothing) As String
            Dim Copy As String
            If ErrorObject Is Nothing Then
                If Err.Number = 0 Then
                    GetErrString = "[no error]"
...
ErrorTrap:
        ...
        '
        '
        Friend Function LogFileCopyPrep(ByVal Source) As String
            Dim Copy As String
            Copy = Source
            Copy = Replace(Copy, vbCrLf, " ")
            Copy = Replace(Copy, vbLf, " ")
        ...
        '========================================================================
        '
        Public Function EncodeSQLText(ByVal expression As Object) As String
            Dim returnString As String = ""
        ...
        '========================================================================
        '
        Public Function EncodeSQLLongText(ByVal expression As Object) As String
            Dim returnString As String = ""
            If expression Is Nothing Then
                returnString = "null"
            Else
        ...
        '========================================================================
        '
        Public Function EncodeSQLDate(ByVal expression As Object) As String
            Dim returnString As String = ""
            ...
            ElseIf Not IsDate(expression) Then
                returnString = "null"
            ElseIf IsDBNull(expression) Then
                returnString = "null"
            ElseIf (expression = Date.MinValue) Then
                returnString = "null"
            Else
...
ErrorTrap:
        ...
        '========================================================================
        '
        Public Function EncodeSQLBoolean(ByVal ExpressionVariant As Object) As String
            '
            'Dim src As String
            '
            EncodeSQLBoolean = SQLFalse
...
ErrorTrap:
        ...
        Public Function dateToSeconds(ByVal sourceDate As Date) As Integer
            Return (sourceDate - New Date(1900, 1, 1)).TotalSeconds
        ...
        ' page content cache
        '
        Public Const cache_pageContent_cacheName = "cache_pageContent"
        Public Const cache_pageContent_fieldList = "ID,Active,ParentID,Name,Headline,MenuHeadline,DateArchive,DateExpires,PubDate,ChildListSortMethodID,ContentControlID,TemplateID" _
        ...
        Public Function getRandomLong() As Integer
            ...
            RandomLimit = (2 ^ 31) - RandomBase - 1
            Randomize()
            getRandomLong = RandomBase + (Rnd() * RandomLimit)
        End Function
        '
        '====================================================================================================
