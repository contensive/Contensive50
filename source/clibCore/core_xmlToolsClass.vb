...
Namespace Contensive.Core
    Public Class xmlToolsClass
        ...
        Public Function GetXMLContentDefinition3(Optional ByVal ContentName As String = "", Optional ByVal IncludeBaseFields As Boolean = False) As String
            ...
            Dim CDefArray() As metaDataClass.CDefClass
            ...
            If iContentName <> "" Then
                SQL = "select id from cccontent where name=" & EncodeSQLText(iContentName)
                    ...
                    If (Not IsBaseContent) Or IncludeBaseFields Then
                        ...
                        If AuthoringTableID <> 0 Then
                            For Ptr = 0 To TableCnt - 1
                                If Tables(0, Ptr) = AuthoringTableID Then
                        ...
                        If ContentTableID <> AuthoringTableID Then
                            If ContentTableID <> 0 Then
                                ...
                                DataSourceName = ""
                                For Ptr = 0 To TableCnt - 1
                                    If Tables(0, Ptr) = ContentTableID Then
                                        TableName = EncodeText(Tables(1, Ptr))
                                        DataSourceName = EncodeText(Tables(2, Ptr))
                                        Exit For
                                    End If
...
ErrorTrap:
        ...
        '========================================================================
        '
        Private Function GetXMLAttributeNumber(ByVal Found As Boolean, ByVal Node As XmlNode, ByVal Name As String, ByVal DefaultIfNotFound As Double) As String
...
ErrorTrap:
        ...
        '
        '
        Private Function CacheLookup(ByVal RecordID As Integer, ByRef Cache As Object) As String
            '
            Dim Ptr As Integer
            '
            CacheLookup = ""
