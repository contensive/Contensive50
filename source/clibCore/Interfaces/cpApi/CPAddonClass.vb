...
Namespace Contensive.Core
    ...
    '
    <ComVisible(True)>
    <ComClass(CPAddonClass.ClassId, CPAddonClass.InterfaceId, CPAddonClass.EventsId)>
...
#End Region
        ...
        '====================================================================================================
        '
        <Obsolete("Create onready or onload events within your javascript. This method will be deprecated.", False)> Public Overrides ReadOnly Property JavaScriptOnLoad() As String
            Get
                Return ""
        ...
        Public Overrides Function installCollectionFile(privatePathFilename As String, ByRef returnUserError As String) As Boolean
            ...
            Try
                ...
                returnOk = addonInstallClass.InstallCollectionsFromPrivateFile(cp.core, privatePathFilename, returnUserError, ignoreReturnedCollectionGuid, False, New List(Of String))
