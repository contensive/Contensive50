...
#End Region
        ...
        Public Overrides Function Insert(ByVal ContentName As String) As Boolean
            ...
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.insert")
            End Try
            Return success
        End Function
        '
        ...
        Public Overrides Function OpenRecord(ByVal ContentName As String, ByVal recordId As Integer, Optional ByVal SelectFieldList As String = "", Optional ByVal ActiveOnly As Boolean = True) As Boolean
            ...
            Try
                ...
                success = cpCore.db.cs_ok(CSPointer)
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.OpenRecord")
            End Try
            Return success
        End Function
        '
        ...
        Public Overrides Function Open(ByVal ContentName As String, Optional ByVal SQLCriteria As String = "", Optional ByVal SortFieldList As String = "", Optional ByVal ActiveOnly As Boolean = True, Optional ByVal SelectFieldList As String = "", Optional ByVal pageSize As Integer = 0, Optional ByVal PageNumber As Integer = 1) As Boolean
            ...
            Try
                ...
                success = cpCore.db.cs_ok(CSPointer)
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.Open")
            End Try
            Return success
        End Function
        '
        ...
        Public Overrides Function OpenGroupUsers(ByVal GroupList As List(Of String), Optional ByVal SQLCriteria As String = "", Optional ByVal SortFieldList As String = "", Optional ByVal ActiveOnly As Boolean = True, Optional ByVal PageSize As Integer = 10, Optional ByVal PageNumber As Integer = 1) As Boolean
            ...
            Try
                ...
                success = OK()
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.OpenGroupUsers")
            End Try
            Return success
        End Function
        '
        ...
        Public Overrides Function OpenSQL(ByVal sql As String) As Boolean
            ...
            Try
                ...
                success = cpCore.db.cs_ok(CSPointer)
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.OpenSQL")
            End Try
            Return success
        End Function
        '
        ...
        Public Overrides Sub Close()
            Try
                ...
                End If
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.Close")
            End Try
        End Sub
        ...
        Public Overrides Sub Delete()
            ...
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.Delete")
            End Try
        End Sub
        ...
        Public Overrides Function FieldOK(ByVal FieldName As String) As Boolean
            ...
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.FieldOK")
            End Try
            Return result
        End Function
        ...
        Public Overrides Function GetAddLink(Optional ByVal PresetNameValueList As String = "", Optional ByVal AllowPaste As Boolean = False) As String
            ...
            Try
                ...
                End If
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.GetAddLink")
                result = String.Empty
            End Try
            Return result
        End Function
        ...
        Public Overrides Function GetBoolean(ByVal FieldName As String) As Boolean
            ...
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.GetBoolean")
            End Try
            Return result
        End Function
        '
        ...
        Public Overrides Function GetDate(ByVal FieldName As String) As Date
            ...
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.GetDate")
            End Try
            Return result
        End Function
        ...
        Public Overrides Function GetEditLink(Optional ByVal AllowCut As Boolean = False) As String
            ...
            Try
                ...
                End If
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.GetEditLink")
                result = String.Empty
            End Try
            Return result
        End Function
        ...
        Public Overrides Function GetFilename(ByVal FieldName As String, Optional ByVal OriginalFilename As String = "", Optional ByVal ContentName As String = "") As String
            ...
            Try
                ...
                End If
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.GetFilename")
                result = String.Empty
            End Try
            Return result
        End Function
        ...
        Public Overrides Function GetInteger(ByVal FieldName As String) As Integer
            ...
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.GetInteger")
            End Try
            Return result
        End Function
        '
        ...
        Public Overrides Function GetNumber(ByVal FieldName As String) As Double
            ...
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.GetNumber")
            End Try
            Return result
        End Function
        '
        ...
        Public Overrides Function GetRowCount() As Integer
            ...
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.GetRowCount")
            End Try
            Return result
        End Function
        '
        ...
        Public Overrides Function GetSQL() As String
            ...
            Try
                ...
                End If
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.GetSQL")
                result = String.Empty
            End Try
            Return result
        End Function
        ...
        Public Overrides Function GetText(ByVal FieldName As String) As String
            ...
            Try
                ...
                End If
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.GetText")
                result = String.Empty
            End Try
            Return result
        End Function
        ...
        Public Overrides Function GetTextFile(ByVal FieldName As String) As String
            ...
            Try
                ...
                End If
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.GetTextFile")
            End Try
            Return result
        End Function
        '
        ...
        Public Overrides Sub GoNext()
            ...
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.GoNext")
            End Try
        End Sub
        '
        '====================================================================================================
        ...
        Public Overrides Function NextOK() As Boolean
            ...
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.NextOK")
            End Try
            Return result
        End Function
        '
        ...
        Public Overrides Function OK() As Boolean
            ...
            Try
                result = cpCore.db.cs_ok(CSPointer)
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.OK")
            End Try
            Return result
        End Function
        '
        ...
        Public Overrides Sub Save()
            ...
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.Save")
            End Try
        End Sub
        '
        '====================================================================================================
        ...
        Public Overrides Sub SetField(ByVal FieldName As String, ByVal FieldValue As Object)
            ...
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.SetField")
            End Try
        End Sub
        '
        '====================================================================================================
        ...
        Public Overrides Sub SetFile(ByVal FieldName As String, ByVal Copy As String, ByVal ContentName As String)
            ...
            Catch ex As Exception
                Call cpCore.handleExceptionAndContinue(ex, "Unexpected error in cs.SetFile")
            End Try
        End Sub
