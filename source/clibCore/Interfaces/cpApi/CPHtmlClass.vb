...
Namespace Contensive.Core
    ...
    '
    <ComVisible(True)>
    <ComClass(CPHtmlClass.ClassId, CPHtmlClass.InterfaceId, CPHtmlClass.EventsId)>
            ...
            Try
                If Method.ToLower = "get" Then
                    If (InnerHtml.IndexOf("type=""file", 0, 1, StringComparison.OrdinalIgnoreCase) >= 0) Then
                        Call cpCore.handleException(New ApplicationException("cp.html.form called with method=get can not contain an upload file (input type=file)"))
                    End If
