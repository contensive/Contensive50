...
Namespace Contensive.Core
    Public Class coreToolsClass
        ...
        Public Function GetForm() As String
            ...
            '
            Button = cpCore.main_GetStreamText2("Button")
            ...
            Else
                ...
                ToolsTable = cpCore.main_GetStreamText2("dtt")
                ToolsContentName = cpCore.main_GetStreamText2("ContentName")
                ToolsQuery = cpCore.main_GetStreamText2("dtq")
                ToolsDataSource = cpCore.main_GetStreamText2("dtds")
...
ErrorTrap:
        ...
        Private Function GetForm_DefineContentFieldsFromTable() As String
            ...
            If Button = ButtonCreateFields Then
                ContentName = cpCore.main_GetStreamText2("ContentName")
                If (ContentName = "") Then
                ...
                Else
                    ...
                    Else
                        Call cpCore.app.db_DeleteContentRecords("Content Fields", "ContentID=" & cpCore.app.db_EncodeSQLNumber(ContentID))
                    End If
                End If
            End If
            '
...
ErrorTrap:
        ...
        Private Function GetForm_ConfigureEdit() As String
            ...
            ToolButton = cpCore.main_GetStreamText2("Button")
                ...
                If (ToolButton <> ButtonCancel) Then
                    ...
                    If RecordCount > 0 Then
                        For RecordPointer = 0 To RecordCount - 1
                            '
                            formFieldName = cpCore.main_GetStreamText2("dtfaName." & RecordPointer)
                                    ...
                                    With cdefFieldKvp.Value
                                        ...
                                        ElseIf (Not .inherited) And (Not formFieldInherited) Then
                                            ...
                                            If True Then
                                                ...
                                                & " Set name=" & cpCore.app.db_EncodeSQLText(formFieldName) _
                                                & ",type=" & formFieldTypeId _
                                                & ",caption=" & cpCore.app.db_EncodeSQLText(cpCore.main_GetStreamText2("dtfaCaption." & RecordPointer)) _
                                                & ",DefaultValue=" & cpCore.app.db_EncodeSQLText(cpCore.main_GetStreamText2("dtfaDefaultValue." & RecordPointer)) _
                                                & ",EditSortPriority=" & cpCore.app.db_EncodeSQLText(cpCore.main_GetStreamInteger("dtfaEditSortPriority." & RecordPointer)) _
                                                & ",Active=" & cpCore.app.db_EncodeSQLBoolean(cpCore.main_GetStreamBoolean("dtfaActive." & RecordPointer)) _
                                                & ",ReadOnly=" & cpCore.app.db_EncodeSQLBoolean(cpCore.main_GetStreamBoolean("dtfaReadOnly." & RecordPointer)) _
                                                & ",Authorable=" & cpCore.app.db_EncodeSQLBoolean(cpCore.main_GetStreamBoolean("dtfaAuthorable." & RecordPointer)) _
                                                & ",Required=" & cpCore.app.db_EncodeSQLBoolean(cpCore.main_GetStreamBoolean("dtfaRequired." & RecordPointer)) _
                                                & ",UniqueName=" & cpCore.app.db_EncodeSQLBoolean(cpCore.main_GetStreamBoolean("dtfaUniqueName." & RecordPointer)) _
                                                & ",TextBuffered=" & cpCore.app.db_EncodeSQLBoolean(cpCore.main_GetStreamBoolean("dtfaTextBuffered." & RecordPointer)) _
                                                & ",Password=" & cpCore.app.db_EncodeSQLBoolean(cpCore.main_GetStreamBoolean("dtfaPassword." & RecordPointer)) _
                                                & ",HTMLContent=" & cpCore.app.db_EncodeSQLBoolean(cpCore.main_GetStreamBoolean("dtfaHTMLContent." & RecordPointer)) _
                                                & ",EditTab=" & cpCore.app.db_EncodeSQLText(cpCore.main_GetStreamText2("dtfaEditTab." & RecordPointer)) _
                                                & ",Scramble=" & cpCore.app.db_EncodeSQLBoolean(cpCore.main_GetStreamBoolean("dtfaScramble." & RecordPointer)) _
                                                & ""
                                                If cpCore.user_isAdmin Then
                                                    SQL &= ",adminonly=" & cpCore.app.db_EncodeSQLBoolean(cpCore.main_GetStreamBoolean("dtfaAdminOnly." & RecordPointer))
                                                End If
                                                If cpCore.user_isDeveloper Then
                                                    SQL &= ",DeveloperOnly=" & cpCore.app.db_EncodeSQLBoolean(cpCore.main_GetStreamBoolean("dtfaDeveloperOnly." & RecordPointer))
                                                End If
                                                ...
                                                '    Call cpCore.app.db_SetCS(CSPointer, "caption", cpCore.main_GetStreamText2("dtfaCaption." & RecordPointer))
                                                '    Call cpCore.app.db_SetCS(CSPointer, "DefaultValue", cpCore.main_GetStreamText2("dtfaDefaultValue." & RecordPointer))
...
ErrorTrap:
        ...
        Private Function GetForm_RootRow(ByVal AdminFormId As Integer, ByVal AdminFormToolId As Integer, ByVal Caption As String, ByVal Description As String) As String
            ...
            GetForm_RootRow = GetForm_RootRow & SpanClassAdminNormal & "<P class=""ccAdminNormal""><A href=""" & cpCore.main_ServerPage & "?af=" & AdminFormToolId.ToString() & """><B>" & Caption & "</b></SPAN></A></p>"
...
ErrorTrap:
        ...
        Private Function GetForm_ManualQuery() As String
            ...
            Try
                ...
                '
                SQLFilename = cpCore.userProperty_getText("SQLArchive")
                If SQLFilename = "" Then
                ...
                End If
                '
                If (cpCore.main_GetStreamText2("button")) = ButtonRun Then
                    ...
                    End If
                    SQL = cpCore.main_GetStreamText2("SQL")
                    If SQL = "" Then
                        SQL = cpCore.main_GetStreamText2("SQLList")
                    End If
                    '
                    ...
                    Else
                        ...
                        '
                        'Dim dtOK As Boolean
                        resultArray = convertDataTabletoArray(RS)
                        '
                ...
                If SQLRows = 0 Then
                    SQLRows = cpCore.userProperty_getInteger("ManualQueryInputRows", 5)
                Else
        ...
        Private Function GetForm_CreateContentDefinition() As String
            ...
            '   print out the submit form
            '
            If (cpCore.main_GetStreamText2("Button") <> "") Then
                '
                ' Process input
                '
                DataSourceID = cpCore.main_GetStreamInteger("DataSourceID")
                DataSourceName = cpCore.main_GetDataSourceByID(DataSourceID)
                ContentName = cpCore.main_GetStreamText2("ContentName")
                TableName = cpCore.main_GetStreamText2("TableName")
                '
                ...
                If (ContentName <> "") And (TableName <> "") And (DataSourceName <> "") Then
                    ...
                    If ParentNavID <> 0 Then
                        CS = cpCore.app.db_csOpen("Navigator Entries", "(name=" & cpCore.app.db_EncodeSQLText("Advanced") & ")and(parentid=" & ParentNavID & ")")
                        ParentNavID = 0
                        ...
                        If ParentNavID <> 0 Then
                            CS = cpCore.app.db_csOpen("Navigator Entries", "(name=" & cpCore.app.db_EncodeSQLText(ContentName) & ")and(parentid=" & NavID & ")")
...
ErrorTrap:
        ...
        Private Function GetForm_ConfigureListing() As String
            ...
            FieldNameToAdd = UCase(cpCore.main_GetStreamText2(RequestNameAddField))
        ...
        Private Function GetForm_ContentDiagnostic() As String
            ...
            If (iDiagActionCount <> 0) And ((Button = ButtonFix) Or (Button = ButtonFixAndRun)) Then
                ...
                For DiagActionPointer = 0 To iDiagActionCount
                    DiagAction = cpCore.main_GetStreamText2("DiagAction" & DiagActionPointer)
                    ...
                    Select Case EncodeInteger(DiagArgument(DiagAction, 0))
                        Case DiagActionSetFieldType
                            ...
                            CS = cpCore.app.db_csOpen("Content Fields", "(ContentID=" & ContentID & ")and(Name=" & cpCore.app.db_EncodeSQLText(DiagArgument(DiagAction, 2)) & ")")
                            If cpCore.app.db_csOk(CS) Then
                        ...
                        Case DiagActionContentDeDupe
                            ContentName = DiagArgument(DiagAction, 1)
                            CS = cpCore.app.db_csOpen("Content", "name=" & cpCore.app.db_EncodeSQLText(ContentName), "ID")
                            If cpCore.app.db_csOk(CS) Then
                                        ...
                                        Do While cpCore.app.db_csOk(CSFields)
                                            ...
                                            Select Case fieldType
                                                ...
                                                Case FieldTypeIdLookup
                                                    ...
                                                    '
                                                    ErrorCount = cpCore.main_PageErrorCount
                                                    bitBucket = cpCore.app.db_GetCSField(CSTestRecord, FieldName)
                                                    ...
                                                    Else
                                                        ...
                                                        End If
                                                        If (LookupList = "") And ((LookupContentID = 0) Or (bitBucket = "") Or (ErrorCount <> cpCore.main_PageErrorCount)) Then
...
ErrorTrap:
        ...
        Private Function GetForm_CreateChildContent() As String
            ...
            If (cpCore.main_GetStreamText2("Button") <> "") Then
                ...
                ChildContentName = cpCore.main_GetStreamText2("ChildContentName")
            ...
            Stream.Add(cpCore.html_GetFormInputCheckBox2("AddAdminMenuEntry", AddAdminMenuEntry))
            Call Stream.Add("<br><br>")
            '
...
ErrorTrap:
        ...
        Private Function Local_GetContentTableName(ByVal ContentName As String) As String
            ...
            RS = cpCore.app.executeSql("Select ccTables.Name as TableName from ccContent Left Join ccTables on ccContent.ContentTableID=ccTables.ID where ccContent.name=" & cpCore.app.db_EncodeSQLText(ContentName))
...
ErrorTrap:
        ...
        Private Function Local_GetContentDataSource(ByVal ContentName As String) As String
            ...
            SQL = "Select ccDataSources.Name" _
                    ...
                    & " where ccContent.name=" & cpCore.app.db_EncodeSQLText(ContentName)
            RS = cpCore.app.executeSql(SQL)
...
ErrorTrap:
        ...
        Private Function GetForm_ConfigureEdit_CheckBox(ByVal Label As String, ByVal Value As String, ByVal Inherited As Boolean) As String
            ...
            Else
                GetForm_ConfigureEdit_CheckBox = GetForm_ConfigureEdit_CheckBox & cpCore.html_GetFormInputCheckBox(Label, Value)
            End If
                ...
                If Count > 0 Then
                    For Pointer = 0 To Count - 1
                        If cpCore.main_GetStreamBoolean("DropIndex." & Pointer) Then
                            IndexName = cpCore.main_GetStreamText2("DropIndexName." & Pointer)
                ...
                If Count > 0 Then
                    For Pointer = 0 To Count - 1
                        If cpCore.main_GetStreamBoolean("AddIndex." & Pointer) Then
                            ...
                            FieldName = cpCore.main_GetStreamText2("AddIndexFieldName." & Pointer)
...
ErrorTrap:
        ...
        Private Function GetForm_LogFiles_Details() As String
            ...
            '
            CurrentPath = cpCore.main_GetStreamText2("SetPath")
            If CurrentPath = "" Then
                CurrentPath = "\"
            ...
            '
            '
            If cpCore.main_GetStreamText2("SourceFile") <> "" Then
                '
                ' Return the content of the file
                '

                Call cpCore.setResponseContentType("text/text")
                Call cpCore.writeAltBuffer(cpCore.app.appRootFiles.ReadFile(cpCore.main_GetStreamText2("SourceFile")))
        ...
        Private Function GetForm_LoadCDef() As String
            ...
            '
            If (cpCore.main_GetStreamText2("button")) <> ButtonSaveandInvalidateCache Then
                '
                ' First pass, initialize
                '
            Else
...
ErrorTrap:
        ...
        Private Function GetForm_Restart() As String
            ...
            If Not cpCore.user_isAdmin Then
                ...
                '
            ElseIf (cpCore.main_GetStreamText2("button")) <> ButtonRestartContensiveApplication Then
                '
                ' First pass, initialize
                '
            Else
...
ErrorTrap:
        ...
        Private Function GetForm_LoadTemplates() As String
            ...
            '
            If (cpCore.main_GetStreamText2("button")) <> ButtonImportTemplates Then
                '
                ' First pass, initialize
                '
            Else
            ...
            Stream.Add("<br>" & cpCore.html_GetFormInputCheckBox2("AllowBodyHTML", AllowBodyHTML) & " Update/Import Soft Templates from the Body of .HTM and .HTML files")
            Stream.Add("<br>" & cpCore.html_GetFormInputCheckBox2("AllowScriptLink", AllowScriptLink) & " Update/Import Hard Templates with links to .ASP and .ASPX scripts")
            Stream.Add("<br>" & cpCore.html_GetFormInputCheckBox2("AllowImageImport", AllowImageImport) & " Update/Import image links (.GIF,.JPG,.PDF ) into the resource library")
            Stream.Add("<br>" & cpCore.html_GetFormInputCheckBox2("AllowStyleImport", AllowStyleImport) & " Import style sheets (.CSS) to Dynamic Styles")
            Call Stream.Add("</SPAN>")
            '
        ...
        Private Function ImportTemplates(ByVal FileRootPath As String, ByVal AppPath As String, ByVal AllowBodyHTML As Boolean, ByVal AllowScriptLink As Boolean, ByVal AllowImageImport As Boolean, ByVal AllowStyleImport As Boolean) As String
            ...
            For Ptr = 0 To UBound(Files)
                ...
                If AllowScriptLink And (InStr(1, Filename, ".asp", vbTextCompare) <> 0) And (Mid(Filename, 1, 1) <> "_") Then
                    ...
                    End If
                    '
                    CS = cpCore.app.db_csOpen("Page Templates", "Link=" & cpCore.app.db_EncodeSQLText(Link))
                    If Not cpCore.app.db_csOk(CS) Then
                        Call cpCore.app.db_csClose(CS)
                ...
                ElseIf AllowBodyHTML And (InStr(1, Filename, ".htm", vbTextCompare) <> 0) And (Mid(Filename, 1, 1) <> "_") Then
                    ...
                    If True Then
                        ...
                        '
                        CS = cpCore.app.db_csOpen("Page Templates", "Source=" & cpCore.app.db_EncodeSQLText(Link))
                        If Not cpCore.app.db_csOk(CS) Then
                            Call cpCore.app.db_csClose(CS)
                            CS = cpCore.app.db_csInsertRecord("Page Templates")
...
ErrorTrap:
        ...
        Private Function LoadCDef(ByVal ContentName As String) As coreMetaDataClass.CDefClass
            ...
            Dim ParentID As Integer
            '
            CSContent = cpCore.app.db_csOpen("Content", "name=" & cpCore.app.db_EncodeSQLText(ContentName))
            If cpCore.app.db_csOk(CSContent) Then
                '
...
ErrorTrap:
        ...
        Private Function GetForm_FindAndReplace() As String
                ...
                If RowCnt > 0 Then
                    For RowPtr = 0 To RowCnt - 1
                        If cpCore.main_GetStreamBoolean("Cdef" & RowPtr) Then
                            lcName = LCase(cpCore.main_GetStreamText2("CDefName" & RowPtr))
                    ...
                    FindText = cpCore.main_GetStreamText2("FindText")
                    ReplaceText = cpCore.main_GetStreamText2("ReplaceText")
            ...
            If FindRows = 0 Then
                FindRows = cpCore.userProperty_getInteger("FindAndReplaceFindRows", 1)
            Else
            ...
            If ReplaceRows = 0 Then
                ReplaceRows = cpCore.userProperty_getInteger("FindAndReplaceReplaceRows", 1)
            Else
            ...
            Do While cpCore.app.db_csOk(CS)
                ...
                If IsDeveloper Or (lcName = "page content") Or (lcName = "copy content") Or (lcName = "page templates") Then
                    ...
                    If InStr(1, "," & CDefList & ",", "," & RecordName & ",") <> 0 Then
                        TopHalf = TopHalf & "<div>" & cpCore.html_GetFormInputCheckBox2("Cdef" & RowPtr, True) & cpCore.main_GetFormInputHidden("CDefName" & RowPtr, RecordName) & "&nbsp;" & cpCore.main_GetCSText(CS, "Name") & "</div>"
                    Else
                        BottomHalf = BottomHalf & "<div>" & cpCore.html_GetFormInputCheckBox2("Cdef" & RowPtr, False) & cpCore.main_GetFormInputHidden("CDefName" & RowPtr, RecordName) & "&nbsp;" & cpCore.main_GetCSText(CS, "Name") & "</div>"
                    End If
                End If
                Call cpCore.app.db_csGoNext(CS)
                RowPtr = RowPtr + 1
