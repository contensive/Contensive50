                                ...
                                If cdefFieldKvp.Value.id = formFieldId Then
                                    ...
                                    With cdefFieldKvp.Value
                                        ...
                                        ElseIf (Not .inherited) And (formFieldInherited) Then
                                            ...
                                            '
                                            CSTarget = CSTarget
                                            Call cpCore.db_DeleteContentRecord("Content Fields", formFieldId)
                                            ReloadCDef = True
                                        ElseIf (Not .inherited) And (Not formFieldInherited) Then
                                            ...
                                            If True Then
                                                ...
                                                If (formFieldName <> "") And (formFieldTypeId <> 0) And ((.nameLc = "") Or (.fieldTypeId = 0)) Then
                                                    ...
                                                    '
                                                    Call cpCore.db.db_CreateSQLTableField(DataSourceName, TableName, formFieldName, formFieldTypeId)
                                                ...
                                                & ",Active=" & cpCore.db.encodeSQLBoolean(cpCore.doc_getBoolean("dtfaActive." & RecordPointer)) _
                                                & ",ReadOnly=" & cpCore.db.encodeSQLBoolean(cpCore.doc_getBoolean("dtfaReadOnly." & RecordPointer)) _
                                                & ",Authorable=" & cpCore.db.encodeSQLBoolean(cpCore.doc_getBoolean("dtfaAuthorable." & RecordPointer)) _
                                                & ",Required=" & cpCore.db.encodeSQLBoolean(cpCore.doc_getBoolean("dtfaRequired." & RecordPointer)) _
                                                & ",UniqueName=" & cpCore.db.encodeSQLBoolean(cpCore.doc_getBoolean("dtfaUniqueName." & RecordPointer)) _
                                                & ",TextBuffered=" & cpCore.db.encodeSQLBoolean(cpCore.doc_getBoolean("dtfaTextBuffered." & RecordPointer)) _
                                                & ",Password=" & cpCore.db.encodeSQLBoolean(cpCore.doc_getBoolean("dtfaPassword." & RecordPointer)) _
                                                & ",HTMLContent=" & cpCore.db.encodeSQLBoolean(cpCore.doc_getBoolean("dtfaHTMLContent." & RecordPointer)) _
                ...
                For DiagActionPointer = 0 To iDiagActionCount
                    ...
                    Select Case EncodeInteger(DiagArgument(DiagAction, 0))
                        ...
                        Case DiagActionDeleteRecord
                            ...
                            Call cpCore.db_DeleteContentRecord(ContentName, RecordID)
                            'end case
                    ...
                    If (DiagActionCount < DiagActionCountMax) Then
                        ...
                        If cpCore.db.cs_Ok(CSPointer) Then
                            Do While cpCore.db.cs_Ok(CSPointer)
                                ...
                                DiagActions(1).Command = CStr(DiagActionContentDeDupe) & "," & cpCore.db.db_GetCSField(CSPointer, "name")
                        ...
                        Else
                            Do While cpCore.db.cs_Ok(CS) And (DiagActionCount < DiagActionCountMax)
                                ...
                                If (FieldName <> "") And (fieldType <> FieldTypeIdRedirect) And (fieldType <> FieldTypeIdManyToMany) Then
                                    ...
                                    CSTest = cpCore.db.db_openCsSql_rev(DataSourceName, SQL)
                                    If CSTest = -1 Then
                                        ...
                                        Do While cpCore.db.cs_Ok(CSFields)
                                            ...
                                            Select Case fieldType
                                                ...
                                                Case FieldTypeIdLookup
                                                    ...
                                                    '
                                                    ErrorCount = cpCore.main_PageErrorCount
                                                    bitBucket = cpCore.db.db_GetCSField(CSTestRecord, FieldName)
                        ...
                        Do
                            ...
                            If CD.fields.Count > 0 Then
                                For Each keyValuePair In CD.fields
                                    ...
                                    Call cpCore.db.db_CreateSQLTableField(CD.ContentDataSourceName, TableName, field.nameLc, field.fieldTypeId)
                                Next
                            End If
                            cpCore.db.db_csGoNext(CSContent)
...
ErrorTrap:
        ...
        '                ParentContentName = cpCore.db.db_GetCSText(CS, "name")
