...
Namespace Contensive.Core
    Public Class toolsClass
        ...
        Const ToolsActionIISReset = 15
        '
        ' ----- Buttons
        '
        'Const ButtonGetTable = "Create Content"
        'Const ButtonContentTest = "  Start Test  "
        'Const ButtonSave = "     Save     "
        'Const ButtonClose = "    Close    "
        'Const ButtonSaveClose = "Save and Close"
        'Const ButtonDuplicateDataSource = "  Duplicate  "
        'Const ButtonAdd = "     Add     "
        Const ButtonCreateFields = " Create Fields "
        Const ButtonRun = "     Run     "
        Const ButtonSelect = "  Select "
        Const ButtonFindAndReplace = " Find and Replace "
        Const ButtonIISReset = " IIS Reset "
        '
        ...
        Public Function GetForm() As String
            ...
            '
            Button = cpCore.main_GetStreamText("Button")
            If (Button = ButtonCancelAll) Then
                '
                ' Cancel to the admin site
                '
                Call cpCore.main_Redirect(cpCore.app.siteProperty_getText("AdminURL", "/admin/"))
            End If
            '
            ' ----- Check permissions
            '
            ...
            Else
                ToolsAction = cpCore.main_GetStreamInteger("dta")
                Button = cpCore.main_GetStreamText("Button")
                AdminFormTool = cpCore.main_GetStreamInteger(RequestNameAdminForm)
                ToolsTable = cpCore.main_GetStreamText("dtt")
                ToolsContentName = cpCore.main_GetStreamText("ContentName")
                ToolsQuery = cpCore.main_GetStreamText("dtq")
                ToolsDataSource = cpCore.main_GetStreamInteger("dtds")
                MenuEntryID = cpCore.main_GetStreamInteger("dtei")
                MenuHeaderID = cpCore.main_GetStreamInteger("dthi")
                MenuDirection = cpCore.main_GetStreamInteger("dtmd")
                DefaultReadOnly = cpCore.main_GetStreamBoolean("dtdreadonly")
                DefaultActive = cpCore.main_GetStreamBoolean("dtdactive")
                DefaultPassword = cpCore.main_GetStreamBoolean("dtdpassword")
                DefaulttextBuffered = cpCore.main_GetStreamBoolean("dtdtextbuffered")
                DefaultRequired = cpCore.main_GetStreamBoolean("dtdrequired")
                DefaultAdminOnly = cpCore.main_GetStreamBoolean("dtdadmin")
                DefaultDeveloperOnly = cpCore.main_GetStreamBoolean("dtddev")
                defaultAddMenu = cpCore.main_GetStreamBoolean("dtdam")
                DefaultCreateBlankRecord = cpCore.main_GetStreamBoolean("dtblank")
                '
                Call cpCore.main_AddRefreshQueryString("dta", ToolsAction)
                'Call cpCore.main_AddRefreshQueryString("Button=" & Button)
                'Call cpCore.main_AddRefreshQueryString("af=" & AdminFormTool)
                '
                cpCore.testPoint("Button = " & Button)
                cpCore.testPoint("ToolsQuery = " & ToolsQuery)
                cpCore.testPoint("ToolsDataSource = " & ToolsDataSource)
                cpCore.testPoint("AdminFormTool = " & AdminFormTool)
                '
                '
                '
                ...
                Else
                    ...
                    Select Case AdminFormTool
                        ...
                        Case AdminFormToolConfigureEdit
                            '
                            Call Stream.Add(GetForm_ConfigureEdit)
                        ...
                        Case Else
                            '
                            cpCore.testPoint("Taking AdminFormToolRoot case")
                            Call Stream.Add(GetForm_Root)
                    End Select
                End If
...
ErrorTrap:
        ...
        Private Function GetForm_DefineContentFieldsFromTable() As String
            ...
            '
            Stream.Add(SpanClassAdminNormal & "<strong><A href=""" & cpCore.main_ServerPage & "?af=" & AdminFormToolRoot & """>Tools</A></strong></SPAN>")
            ...
            ItemCount = 0
            CSPointer = cpCore.app.db_csOpen("Content", "", "name")
            Do While cpCore.app.db_csOk(CSPointer)
                Stream.Add("<option value=""" & cpCore.main_GetCSText(CSPointer, "name") & """>" & cpCore.main_GetCSText(CSPointer, "name") & "</option>")
            ...
            If Button = ButtonCreateFields Then
                ContentName = cpCore.main_GetStreamText("ContentName")
                If (ContentName = "") Then
                ...
                Else
                    ...
                    Else
                        Call cpCore.app.db_DeleteContentRecords("Content Fields", "ContentID=" & EncodeSQLNumber(ContentID))
                    End If
                End If
            End If
            '
            GetForm_DefineContentFieldsFromTable = OpenFormTable(ButtonList) & Stream.Text & CloseFormTable(ButtonList)
            Exit Function
            '
            ' ----- Error Trap
            '
ErrorTrap:
        ...
        Private Class fieldSortClass
            ...
            Public field As metaDataClass.CDefFieldClass
        End Class
        '
        '=============================================================================
        ...
        Private Function GetForm_ConfigureEdit() As String
            ...
            '
            ContentID = cpCore.main_GetStreamInteger("" & RequestNameToolContentID & "")
            ToolButton = cpCore.main_GetStreamText("Button")
            ReloadCDef = cpCore.main_GetStreamBoolean("ReloadCDef")
            ...
            If (ToolButton <> "") Then
                If (ToolButton <> ButtonCancel) Then
                    cpCore.testPoint("ConfigureEdit, Process Save")
                    '
                    ...
                    ' ----- Save the input
                    '
                    RecordCount = EncodeInteger(cpCore.main_GetStreamInteger("dtfaRecordCount"))
                                    ...
                                    ElseIf (Not .inherited) And (Not SubmittedInherited) Then
                                        ...
                                        If True Then
                                            ...
                                            SQL = "Update ccFields" _
                                                ...
                                                & ",Active=" & EncodeSQLBoolean(cpCore.main_GetStreamBoolean("dtfaActive." & RecordPointer)) _
                                                & ",ReadOnly=" & EncodeSQLBoolean(cpCore.main_GetStreamBoolean("dtfaReadOnly." & RecordPointer)) _
                                                & ",Authorable=" & EncodeSQLBoolean(cpCore.main_GetStreamBoolean("dtfaAuthorable." & RecordPointer)) _
                                                & ",Required=" & EncodeSQLBoolean(cpCore.main_GetStreamBoolean("dtfaRequired." & RecordPointer)) _
                                                & ",UniqueName=" & EncodeSQLBoolean(cpCore.main_GetStreamBoolean("dtfaUniqueName." & RecordPointer)) _
                                                & ",TextBuffered=" & EncodeSQLBoolean(cpCore.main_GetStreamBoolean("dtfaTextBuffered." & RecordPointer)) _
                                                & ",Password=" & EncodeSQLBoolean(cpCore.main_GetStreamBoolean("dtfaPassword." & RecordPointer)) _
                                                & ",HTMLContent=" & EncodeSQLBoolean(cpCore.main_GetStreamBoolean("dtfaHTMLContent." & RecordPointer)) _
                ...
                If (ToolButton = ButtonAdd) Then
                    cpCore.testPoint("ConfigureEdit, Process Add Button")
                    '
                ...
                If AllowContentAutoLoad Then
                    Call cpCore.app.siteProperty_set("AllowContentAutoLoad", AllowContentAutoLoad)
                End If
                '
                ...
                If (ToolButton = ButtonCancel) Or (ToolButton = ButtonOK) Then
                    ...
                    ' ----- Exit back to menu
                    '
                    Call cpCore.main_Redirect(cpCore.main_ServerProtocol & cpCore.main_ServerDomain & cpCore.main_ServerPath & cpCore.main_ServerPage & "?af=" & AdminFormTools)
                End If
            End If
            '
            '--------------------------------------------------------------------------------
            ...
            '--------------------------------------------------------------------------------
            '
            cpCore.testPoint("ConfigureEdit, Start Form")
            Stream.Add(SpanClassAdminNormal & "<strong><a href=""" & cpCore.main_ServerPage & "?af=" & AdminFormToolRoot & """>Tools</a></strong>&nbsp;»&nbsp;Manage Admin Edit Fields</span>")
            Stream.Add("<div>")
            ...
            If (ContentID <> 0) Then
                    ...
                    For Each fieldsort As fieldSortClass In fieldList
                        With fieldsort.field
                            ...
                            Else
                                ...
                                '
                                Dim parentField As metaDataClass.CDefFieldClass = Nothing
                                For Each kvp As KeyValuePair(Of String, metaDataClass.CDefFieldClass) In ParentCDef.fields
                ...
                End If
            End If
            cpCore.testPoint("ConfigureEdit, Form Done")
            If ContentID <> 0 Then
                '
                ' Save the content selection
                '
                Call Stream.Add(cpCore.main_GetFormInputHidden(RequestNameToolContentID, ContentID))
            Else
                '
...
ErrorTrap:
        ...
        Private Function GetForm_Root() As String
            ...
            Stream.Add(GetForm_RootRow(AdminFormTools, AdminformToolCreateGUID, "Create GUID", "Use this tool to create a new GUID. This is useful when creating a new Addon."))
            Stream.Add("</table>")
            GetForm_Root = OpenFormTable(ButtonList) & Stream.Text & CloseFormTable(ButtonList)
            Exit Function
            '
            ' ----- Error Trap
            '
ErrorTrap:
        ...
        '==================================================================================
        '
        Private Function GetForm_RootRow(ByVal AdminForm As String, ByVal AdminFormTool As String, ByVal Caption As String, ByVal Description As String) As String
            On Error GoTo ErrorTrap
            '
            GetForm_RootRow = GetForm_RootRow & "<tr><td colspan=""2"">"
            GetForm_RootRow = GetForm_RootRow & SpanClassAdminNormal & "<P class=""ccAdminNormal""><A href=""" & cpCore.main_ServerPage & "?af=" & AdminFormTool & """><B>" & Caption & "</b></SPAN></A></p>"
...
ErrorTrap:
        ...
        Private Function GetTitle(ByVal Title As String, ByVal Description As String) As String
            ...
            GetTitle = GetTitle & "<P>" & SpanClassAdminNormal _
                    & "<A href=""" & cpCore.main_ServerPage & "?af=" & AdminFormToolRoot & """><B>Tools</b></A>" _
                    & "&nbsp;&gt;&nbsp;" _
                    & Title _
...
ErrorTrap:
        ...
        Private Function GetForm_ManualQuery() As String
            ...
            Try
                ...
                '
                SQLFilename = cpCore.main_GetMemberProperty("SQLArchive")
                If SQLFilename = "" Then
                    SQLFilename = "SQLArchive" & Format(cpCore.userId, "000000000") & ".txt"
                    Call cpCore.main_SetMemberProperty("SQLArchive", SQLFilename)
                End If
                SQLArchive = cpCore.app.cdnFiles.ReadFile(SQLFilename)
                '
                ' Read in arguments if available
                '
                Timeout = cpCore.main_GetStreamInteger("Timeout")
                If Timeout = 0 Then
                    Timeout = 30
                End If
                '
                PageSize = cpCore.main_GetStreamInteger("PageSize")
                If PageSize = 0 Then
                    PageSize = 10
                End If
                '
                PageNumber = cpCore.main_GetStreamInteger("PageNumber")
                If PageNumber = 0 Then
                    PageNumber = 1
                End If
                '
                If (cpCore.main_GetStreamText("button")) = ButtonRun Then
                    DataSourceID = cpCore.main_GetStreamInteger("DataSourceID")
                    DataSourceName = ""
                    ...
                    End If
                    SQL = cpCore.main_GetStreamText("SQL")
                    If SQL = "" Then
                        SQL = cpCore.main_GetStreamText("SQLList")
                    End If
                    '
                    ...
                    If SQL <> "" Then
                        ...
                        Loop
                        Call cpCore.app.appRootFiles.SaveFile(SQLFilename, SQLArchive)
                    End If
                    '
                    ' Run the SQL
                    '
                    ...
                    Try
                        RS = cpCore.app.executeSql(SQL, DataSourceName, PageSize * (PageNumber - 1), PageSize)
                    ...
                    Else
                        ...
                        '
                        'Dim dtOK As Boolean
                        This = convertDataTabletoArray(RS)
                        '
                        RowMax = UBound(This, 2)
                        ColumnMax = UBound(This, 1)
                        RowStart = "<tr>"
                        RowEnd = "</tr>"
                        ...
                        For RowPointer = 0 To RowMax
                            ...
                            For ColumnPointer = 0 To ColumnMax
                                CellData = This(ColumnPointer, RowPointer)
                                ...
                                ElseIf CellData = "" Then
                                    Stream.Add(ColumnStart & "[empty]" & ColumnEnd)
                                Else
                                    Stream.Add(ColumnStart & EncodeHTML(EncodeText(CellData)) & ColumnEnd)
                                End If
                            Next
                            Stream.Add(RowEnd)
                        Next
                ...
                SQLRows = cpCore.main_GetStreamInteger("SQLRows")
                If SQLRows = 0 Then
                    SQLRows = cpCore.main_GetMemberProperty("ManualQueryInputRows", "5")
                Else
                    Call cpCore.main_SetMemberProperty("ManualQueryInputRows", CStr(SQLRows))
                End If
                ...
                '
                SelectFieldWidthLimit = (cpCore.app.siteProperty_getinteger("SelectFieldWidthLimit", "200"))
                If SQLArchive <> "" Then
                ...
                If IsNull(PageSize) Then
                    PageSize = 100
                End If
                Call Stream.Add("<br>Page Size:<br>" & cpCore.main_GetFormInputText("PageSize", PageSize))
                '
                If IsNull(PageNumber) Then
                    PageNumber = 1
                End If
                Call Stream.Add("<br>Page Number:<br>" & cpCore.main_GetFormInputText("PageNumber", PageNumber))
                '
                If IsNull(Timeout) Then
                    Timeout = 30
                End If
                Call Stream.Add("<br>Timeout (sec):<br>" & cpCore.main_GetFormInputText("Timeout", Timeout))
                '
        ...
        Private Function GetForm_CreateContentDefinition() As String
            ...
            '   print out the submit form
            '
            If (cpCore.main_GetStreamText("Button") <> "") Then
                '
                ' Process input
                '
                DataSourceID = cpCore.main_GetStreamInteger("DataSourceID")
                DataSourceName = cpCore.main_GetDataSourceByID(DataSourceID)
                ContentName = cpCore.main_GetStreamText("ContentName")
                TableName = cpCore.main_GetStreamText("TableName")
                '
                ...
                If (ContentName <> "") And (TableName <> "") And (DataSourceName <> "") Then
                    ...
                    If ParentNavID <> 0 Then
                        CS = cpCore.app.db_csOpen("Navigator Entries", "(name=" & EncodeSQLText("Advanced") & ")and(parentid=" & ParentNavID & ")")
                        ParentNavID = 0
                        If cpCore.app.db_csOk(CS) Then
                            ParentNavID = cpCore.app.db_GetCSInteger(CS, "ID")
                        End If
                        Call cpCore.app.db_csClose(CS)
                        If ParentNavID <> 0 Then
                            CS = cpCore.app.db_csOpen("Navigator Entries", "(name=" & EncodeSQLText(ContentName) & ")and(parentid=" & NavID & ")")
                            If Not cpCore.app.db_csOk(CS) Then
                                Call cpCore.app.db_csClose(CS)
                                CS = cpCore.app.db_csInsertRecord("Navigator Entries")
                            End If
                            If cpCore.app.db_csOk(CS) Then
                                Call cpCore.app.db_setCS(CS, "name", ContentName)
                                Call cpCore.app.db_setCS(CS, "parentid", ParentNavID)
            ...
            Call Stream.Add(cpCore.main_GetFormInputText("ContentName", ContentName, 1, 40))
            Call Stream.Add("<br><br>")
            Call Stream.Add("Table Name<br>")
            Call Stream.Add(cpCore.main_GetFormInputText("TableName", TableName, 1, 40))
            Call Stream.Add("<br><br>")
            ...
            'GetForm_CreateContentDefinition = OpenFormTable( ButtonList) & Stream.Text & CloseFormTable(ButtonList)
...
ErrorTrap:
        ...
        Private Function GetForm_ConfigureListing() As String
            ...
            '
            ToolsAction = cpCore.main_GetStreamInteger("dta")
            TargetFieldID = cpCore.main_GetStreamInteger("fi")
            ContentID = cpCore.main_GetStreamInteger(RequestNameToolContentID)
            'ColumnPointer = cpCore.main_GetStreamInteger("dtcn")
            FieldNameToAdd = UCase(cpCore.main_GetStreamText(RequestNameAddField))
            FieldIDToAdd = cpCore.main_GetStreamInteger(RequestNameAddFieldID)
            ButtonList = ButtonCancel & "," & ButtonSelect
            ReloadCDef = cpCore.main_GetStreamBoolean("ReloadCDef")
            '
            '--------------------------------------------------------------------------------
            ...
            If ContentID <> 0 Then
                ...
                If ToolsAction <> 0 Then
                        ...
                        For Each keyValuePair In CDef.fields
                            ...
                            If field.id = FieldIDToAdd Then
                                ...
                                If field.inherited Then
                                    ...
                                    CSSource = cpCore.app.db_csOpen("Content Fields", "(ContentID=" & SourceContentID & ")and(Name=" & EncodeSQLText(SourceName) & ")")
                                    If cpCore.app.db_csOk(CSSource) Then
                                        CSTarget = cpCore.app.db_csInsertRecord("Content Fields")
                                        If cpCore.app.db_csOk(CSTarget) Then
                                            Call cpCore.main_CopyCSRecord(CSSource, CSTarget)
                    ...
                    For Each keyValuePair In CDef.adminColumns
                        Dim adminColumn As metaDataClass.CDefAdminColumnClass = keyValuePair.Value
                        Dim field As metaDataClass.CDefFieldClass = CDef.fields(adminColumn.Name)
                        If field.inherited Then
                            SourceContentID = field.contentId
                            SourceName = field.nameLc
                            CSSource = cpCore.app.db_csOpen("Content Fields", "(ContentID=" & SourceContentID & ")and(Name=" & EncodeSQLText(SourceName) & ")")
                    ...
                    Select Case ToolsAction
                            ...
                            If FieldIDToAdd <> 0 Then
                                ...
                                If CDef.adminColumns.Count > 1 Then
                                    For Each keyValuePair In CDef.adminColumns
                                        Dim adminColumn As metaDataClass.CDefAdminColumnClass = keyValuePair.Value
                                        Dim field As metaDataClass.CDefFieldClass = CDef.fields(adminColumn.Name)
                                        CSPointer = cpCore.main_OpenCSContentRecord("Content Fields", field.id)
                                        Call cpCore.app.db_setCS(CSPointer, "IndexColumn", (columnPtr) * 10)
                                        Call cpCore.app.db_setCS(CSPointer, "IndexWidth", Int((adminColumn.Width * 80) / ColumnWidthTotal))
                                        Call cpCore.app.db_csClose(CSPointer)
                                        columnPtr += 1
                                    Next
                                End If
                                CSPointer = cpCore.main_OpenCSContentRecord("Content Fields", FieldIDToAdd, False, False)
                                If cpCore.app.db_csOk(CSPointer) Then
                                    Call cpCore.app.db_setCS(CSPointer, "IndexColumn", columnPtr * 10)
                                    Call cpCore.app.db_setCS(CSPointer, "IndexWidth", 20)
                                    Call cpCore.app.db_setCS(CSPointer, "IndexSortPriority", 99)
                                    Call cpCore.app.db_setCS(CSPointer, "IndexSortDirection", 1)
                                End If
                                Call cpCore.app.db_csClose(CSPointer)
                                ReloadCDef = True
                            End If
                            ...
                            If CDef.adminColumns.Count > 1 Then
                                ...
                                For Each keyValuePair In CDef.adminColumns
                                    ...
                                    If fieldId = TargetFieldID Then
                                        Call cpCore.app.db_setCS(CSPointer, "IndexColumn", 0)
                                        Call cpCore.app.db_setCS(CSPointer, "IndexWidth", 0)
                                        Call cpCore.app.db_setCS(CSPointer, "IndexSortPriority", 0)
                                        Call cpCore.app.db_setCS(CSPointer, "IndexSortDirection", 0)
                                    Else
                                        Call cpCore.app.db_setCS(CSPointer, "IndexColumn", (columnPtr) * 10)
                                        Call cpCore.app.db_setCS(CSPointer, "IndexWidth", Int((adminColumn.Width * 100) / ColumnWidthTotal))
                                    End If
                                    Call cpCore.app.db_csClose(CSPointer)
                                    columnPtr += 1
                                Next
                        ...
                        Case ToolsActionMoveFieldRight
                            ...
                            If CDef.adminColumns.Count > 1 Then
                                ...
                                For Each keyValuePair In CDef.adminColumns
                                    ...
                                    CS1 = cpCore.main_OpenCSContentRecord("Content Fields", field.id)
                                    If (CDef.fields(FieldName.ToLower()).id = TargetFieldID) And (columnPtr < CDef.adminColumns.Count) Then
                                        Call cpCore.app.db_setCS(CS1, "IndexColumn", (columnPtr + 1) * 10)
                                        '
                                        MoveNextColumn = True
                                    ...
                                    Else
                                        ...
                                        '
                                        Call cpCore.app.db_setCS(CS1, "IndexColumn", (columnPtr) * 10)
                                        MoveNextColumn = False
                                    End If
                                    Call cpCore.app.db_setCS(CS1, "IndexWidth", Int((adminColumn.Width * 100) / ColumnWidthTotal))
                                    Call cpCore.app.db_csClose(CS1)
                                    columnPtr += 1
                                Next
                                ReloadCDef = True
                            End If
                        ...
                        Case ToolsActionMoveFieldLeft
                            ...
                            '                Call cpCore.app.db_SetCS(CSPointer, "IndexSortDirection", 0)
                            '            End If
                            '            Call cpCore.app.db_SetCS(CSPointer, "IndexColumn", (ColumnPointer) * 10)
                            '            Call cpCore.app.db_SetCS(CSPointer, "IndexWidth", Int((CDef.adminColumns(ColumnPointer).Width * 100) / ColumnWidthTotal))
                            '            Call cpCore.app.db_closeCS(CSPointer)
                            '        Next
                            '        ReloadCDef = True
                            '    End If
                            ...
                            '                    '
                            '                    Call cpCore.app.db_SetCS(CSPointer, "IndexWidth", Int(CDef.adminColumns(ColumnPointer).Width + ColumnWidthIncrease))
                            '                Else
                            '                    '
                            ...
                            '                    Call cpCore.app.db_SetCS(CSPointer, "IndexWidth", Int(FieldWidth))
                            '                End If
                            '                Call cpCore.app.db_SetCS(CSPointer, "IndexColumn", (ColumnPointer) * 10)
                            '                Call cpCore.app.db_closeCS(CSPointer)
                            '            Next
                            ...
                            '                    Call cpCore.app.db_SetCS(CSPointer, "IndexWidth", FieldWidth)
                            '                Else
                            '                    '
                            '                    ' non-targets get their share of the shrinkage
                            '                    '
                ...
                If CDef.adminColumns.Count > 0 Then
                    ...
                    If ColumnWidthTotal > 0 Then
                        ...
                        For ColumnCount = 0 To CDef.adminColumns.Count - 1
                            ...
                            '
                            ColumnWidth = 100 * (CDef.adminColumns(ColumnCount).Width / ColumnWidthTotal)
                            ...
                            With CDef.fields(FieldName.ToLower())
                                ...
                                End If
                                AStart = "<A href=""" & cpCore.main_ServerPage & "?" & RequestNameToolContentID & "=" & ContentID & "&af=" & AdminFormToolConfigureListing & "&fi=" & fieldId & "&dtcn=" & ColumnCount
                        ...
                        With field
                            ...
                            If skipField Then
                                ...
                                Else
                                    ...
                                    '
                                    Stream.Add("<A href=""" & cpCore.main_ServerPage & "?" & RequestNameToolContentID & "=" & ContentID & "&af=" & AdminFormToolConfigureListing & "&fi=" & .id & "&dta=" & ToolsActionAddField & "&" & RequestNameAddFieldID & "=" & .id & """><IMG src=""/ccLib/images/LibButtonAddUp.gif"" width=""50"" height=""15"" border=""0""></A> " & .caption & "<br>")
                                End If
                            End If
                        End With
                    Next
...
ErrorTrap:
        ...
        Private Function GetForm_ContentDiagnostic() As String
            ...
            Dim FieldName As String
            Dim BitBucketVariant As Object
            Dim ContentID As Integer
            ...
            '
            iDiagActionCount = cpCore.main_GetStreamInteger("DiagActionCount")
            Button = cpCore.main_GetStreamText("Button")
            If (iDiagActionCount <> 0) And ((Button = ButtonFix) Or (Button = ButtonFixAndRun)) Then
                ...
                For DiagActionPointer = 0 To iDiagActionCount
                    DiagAction = cpCore.main_GetStreamText("DiagAction" & DiagActionPointer)
                    Stream.Add("Perform Action " & DiagActionPointer & " - " & DiagAction & "<br>")
                    Select Case DiagArgument(DiagAction, 0)
                        Case DiagActionSetFieldType
                            '
                            ' ----- Set Field Type
                            '
                            ContentID = Local_GetContentID(DiagArgument(DiagAction, 1))
                            CS = cpCore.app.db_csOpen("Content Fields", "(ContentID=" & ContentID & ")and(Name=" & EncodeSQLText(DiagArgument(DiagAction, 2)) & ")")
                            If cpCore.app.db_csOk(CS) Then
                                Call cpCore.app.db_setCS(CS, "Type", DiagArgument(DiagAction, 3))
                            End If
                            Call cpCore.app.db_csClose(CS)
                            'end case
                        Case DiagActionSetFieldInactive
                            ...
                            CS = cpCore.app.db_csOpen("Content Fields", "(ContentID=" & ContentID & ")and(Name=" & EncodeSQLText(DiagArgument(DiagAction, 2)) & ")")
                            If cpCore.app.db_csOk(CS) Then
                                Call cpCore.app.db_setCS(CS, "active", 0)
                            End If
                            Call cpCore.app.db_csClose(CS)
                            'end case
                        Case DiagActionDeleteRecord
                            ...
                            Call cpCore.main_DeleteContentRecord(ContentName, RecordID)
                            'end case
                        Case DiagActionContentDeDupe
                            ContentName = DiagArgument(DiagAction, 1)
                            CS = cpCore.app.db_csOpen("Content", "name=" & EncodeSQLText(ContentName), "ID")
                            If cpCore.app.db_csOk(CS) Then
                        ...
                        Case DiagActionSetRecordInactive
                            ...
                            ContentName = DiagArgument(DiagAction, 1)
                            RecordID = EncodeInteger(DiagArgument(DiagAction, 2))
                            CS = cpCore.app.db_csOpen(ContentName, "(ID=" & RecordID & ")")
                            If cpCore.app.db_csOk(CS) Then
                                Call cpCore.app.db_setCS(CS, "active", 0)
                            End If
                            Call cpCore.app.db_csClose(CS)
                        ...
                        Case DiagActionSetFieldNotRequired
                            ...
                            CS = cpCore.app.db_csOpen(ContentName, "(ID=" & RecordID & ")")
                            If cpCore.app.db_csOk(CS) Then
                                Call cpCore.app.db_setCS(CS, "required", 0)
                            End If
                            Call cpCore.app.db_csClose(CS)
                            'end case
                    End Select
            ...
            If ((Button = ButtonRun) Or (Button = ButtonFixAndRun)) Then
                ...
                ' Process input
                '
                If Not cpCore.app.siteProperty_trapErrors Then
                    '
                ...
                Else
                    Call cpCore.main_SetStreamBuffer(False)
                    '
                    ...
                    If (DiagActionCount < DiagActionCountMax) Then
                        ...
                        If cpCore.app.db_csOk(CSPointer) Then
                            Do While cpCore.app.db_csOk(CSPointer)
                                DiagProblem = "PROBLEM: There are " & cpCore.main_GetCSText(CSPointer, "RecordCount") & " records in the Content table with the name [" & cpCore.main_GetCSText(CSPointer, "Name") & "]"
                                ReDim DiagActions(2)
                                ...
                                DiagActions(1).Command = CStr(DiagActionContentDeDupe) & "," & cpCore.app.db_GetCSField(CSPointer, "name")
                    ...
                    If (DiagActionCount < DiagActionCountMax) Then
                        ...
                        If Not cpCore.app.db_csOk(CS) Then
                            ...
                            Stream.Add(GetDiagError(DiagProblem, DiagActions))
                        Else
                            Do While cpCore.app.db_csOk(CS) And (DiagActionCount < DiagActionCountMax)
                                FieldName = cpCore.main_GetCSText(CS, "FieldName")
                                fieldType = cpCore.app.db_GetCSInteger(CS, "FieldType")
                                FieldRequired = cpCore.main_GetCSBoolean(CS, "FieldRequired")
                                FieldAuthorable = cpCore.main_GetCSBoolean(CS, "FieldAuthorable")
                                ContentName = cpCore.main_GetCSText(CS, "ContentName")
                                TableName = cpCore.main_GetCSText(CS, "TableName")
                                DataSourceName = cpCore.main_GetCSText(CS, "DataSourceName")
                                If DataSourceName = "" Then
                                    DataSourceName = "Default"
                                End If
                                ...
                                If (FieldName <> "") And (fieldType <> FieldTypeIdRedirect) And (fieldType <> FieldTypeIdManyToMany) Then
                                    ...
                                    CSTest = cpCore.app.db_openCsSql_rev(DataSourceName, SQL)
                                    If CSTest = -1 Then
                                    ...
                                    End If
                                End If
                                Call cpCore.app.db_csClose(CSTest)
                    ...
                    If (DiagActionCount < DiagActionCountMax) Then
                        ...
                        '
                        CSContent = cpCore.app.db_csOpen("Content")
                        If Not cpCore.app.db_csOk(CSContent) Then
                            DiagProblem = "PROBLEM: No Content entries were found in the content table."
                            ReDim DiagActions(1)
                            DiagActions(0).Name = "Ignore, or handle this issue manually"
                            DiagActions(0).Command = ""
                            Stream.Add(GetDiagError(DiagProblem, DiagActions))
                        Else
                            Do While cpCore.app.db_csOk(CSContent) And (DiagActionCount < DiagActionCountMax)
                                ContentID = cpCore.app.db_GetCSInteger(CSContent, "ID")
                                ContentName = cpCore.main_GetCSText(CSContent, "name")
                                CSTestRecord = cpCore.app.db_csInsertRecord(ContentName)
                                If Not cpCore.app.db_csOk(CSTestRecord) Then
                                    ...
                                    Stream.Add(GetDiagError(DiagProblem, DiagActions))
                                Else
                                    TestRecordID = cpCore.app.db_GetCSInteger(CSTestRecord, "id")
                                    If TestRecordID = 0 Then
                                        ...
                                        Stream.Add(GetDiagError(DiagProblem, DiagActions))
                                    Else
                                        CSFields = cpCore.app.db_csOpen("Content Fields", "ContentID=" & ContentID)
                                        Do While cpCore.app.db_csOk(CSFields)
                                            '
                                            ' ----- read the value of the field to test its presents
                                            '
                                            FieldName = cpCore.main_GetCSText(CSFields, "name")
                                            fieldType = cpCore.app.db_GetCSInteger(CSFields, "Type")
                                            Select Case fieldType
                                                ...
                                                Case FieldTypeIdRedirect
                                                    ...
                                                    '
                                                    RedirectContentID = cpCore.app.db_GetCSInteger(CSFields, "RedirectContentID")
                                                    ErrorCount = cpCore.main_PageErrorCount
                                                    BitBucketVariant = Local_GetContentNameByID(RedirectContentID)
                                                    If IsNull(BitBucketVariant) Or (ErrorCount <> cpCore.main_PageErrorCount) Then
                                                ...
                                                Case FieldTypeIdLookup
                                                    ...
                                                    '
                                                    ErrorCount = cpCore.main_PageErrorCount
                                                    BitBucketVariant = cpCore.app.db_GetCSField(CSTestRecord, FieldName)
                                                    If ErrorCount <> cpCore.main_PageErrorCount Then
                                                    ...
                                                    Else
                                                        BitBucketVariant = ""
                                                        LookupList = cpCore.main_GetCSText(CSFields, "Lookuplist")
                                                        LookupContentID = cpCore.app.db_GetCSInteger(CSFields, "LookupContentID")
                                                        If LookupContentID <> 0 Then
                                                            ErrorCount = cpCore.main_PageErrorCount
                                                            BitBucketVariant = Local_GetContentNameByID(LookupContentID)
                                                        End If
                                                        If (LookupList = "") And ((LookupContentID = 0) Or (BitBucketVariant = "") Or (ErrorCount <> cpCore.main_PageErrorCount)) Then
                                                ...
                                                Case Else
                                                    ...
                                                    End If
                                            End Select
                                            cpCore.app.db_csGoNext(CSFields)
                                        Loop
                                    End If
                                    Call cpCore.app.db_csClose(CSFields)
                                    Call cpCore.app.db_csClose(CSTestRecord)
                                    Call cpCore.main_DeleteContentRecord(ContentName, TestRecordID)
                                End If
                                cpCore.app.db_csGoNext(CSContent)
                            Loop
                        End If
                        Call cpCore.app.db_csClose(CSContent)
                    End If
                    '
                    ' ----- Check menu entries
                    '
                    If (DiagActionCount < DiagActionCountMax) Then
                        ...
                        CSPointer = cpCore.app.db_csOpen("Menu Entries")
                        If Not cpCore.app.db_csOk(CSPointer) Then
                            ...
                            Stream.Add(GetDiagError(DiagProblem, DiagActions))
                        Else
                            Do While cpCore.app.db_csOk(CSPointer) And (DiagActionCount < DiagActionCountMax)
                                ContentID = cpCore.app.db_GetCSInteger(CSPointer, "ContentID")
                                If ContentID <> 0 Then
                                    CSContent = cpCore.app.db_csOpen("Content", "ID=" & ContentID)
                                    If Not cpCore.app.db_csOk(CSContent) Then
                                        DiagProblem = "PROBLEM: Menu Entry [" & cpCore.main_GetCSText(CSPointer, "name") & "] points to an invalid Content Definition."
                                        ReDim DiagActions(3)
                                        DiagActions(0).Name = "Ignore, or handle this issue manually"
                                        DiagActions(0).Command = ""
                                        DiagActions(1).Name = "Remove this menu entry"
                                        DiagActions(1).Command = CStr(DiagActionDeleteRecord) & ",Menu Entries," & cpCore.app.db_GetCSInteger(CSPointer, "ID")
                                        Stream.Add(GetDiagError(DiagProblem, DiagActions))
                                    End If
                                    Call cpCore.app.db_csClose(CSContent)
                                End If
                    ...
                    '
                    Stream.Add(cpCore.main_GetFormInputHidden("DiagActionCount", DiagActionCount))
                End If
            End If
            '
            ...
            '
            GetForm_ContentDiagnostic = OpenFormTable(ButtonList) & Stream.Text & CloseFormTable(ButtonList)
            Exit Function
            '
            ' ----- Error Trap
            '
ErrorTrap:
        ...
        Private Sub NormalizeIndexColumns(ByVal ContentID As Integer)
            ...
            '
            CSPointer = cpCore.app.db_csOpen("Content Fields", "(ContentID=" & ContentID & ")", "IndexColumn")
            If Not cpCore.app.db_csOk(CSPointer) Then
            ...
            Else
                ...
                ColumnCounter = 0
                Do While cpCore.app.db_csOk(CSPointer)
                    IndexColumn = cpCore.app.db_GetCSInteger(CSPointer, "IndexColumn")
                    ColumnWidth = cpCore.app.db_GetCSInteger(CSPointer, "IndexWidth")
                    ...
                    Else
                        ...
                        '
                        Call cpCore.app.db_setCS(CSPointer, "IndexColumn", ColumnCounter)
                ...
                If ColumnCounter = 0 Then
                    ...
                    '
                    Call cpCore.app.db_firstCSRecord(CSPointer)
                    Do While cpCore.app.db_csOk(CSPointer)
                        Select Case UCase(cpCore.main_GetCSText(CSPointer, "name"))
                            Case "ACTIVE"
                                Call cpCore.app.db_setCS(CSPointer, "IndexColumn", 0)
                                Call cpCore.app.db_setCS(CSPointer, "IndexWidth", 20)
                                ColumnWidthTotal = ColumnWidthTotal + 20
                            Case "NAME"
                                Call cpCore.app.db_setCS(CSPointer, "IndexColumn", 1)
                                Call cpCore.app.db_setCS(CSPointer, "IndexWidth", 80)
                ...
                If ColumnWidthTotal > 0 Then
                    ...
                    Do While cpCore.app.db_csOk(CSPointer)
                        ColumnWidth = cpCore.app.db_GetCSInteger(CSPointer, "IndexWidth")
                        ColumnWidth = (ColumnWidth * 100) / CDbl(ColumnWidthTotal)
                        Call cpCore.app.db_setCS(CSPointer, "IndexWidth", ColumnWidth)
                        cpCore.app.db_csGoNext(CSPointer)
                    Loop
                End If
            End If
            ...
            '
            CSPointer = cpCore.app.db_csOpen("Content Fields", "(ContentID=" & ContentID & ")", "IndexSortPriority, IndexColumn")
            If Not cpCore.app.db_csOk(CSPointer) Then
            ...
            Else
                ...
                Do While cpCore.app.db_csOk(CSPointer)
                    SortDirection = 0
                    If (cpCore.app.db_GetCSInteger(CSPointer, "IndexColumn") = 0) Then
                        Call cpCore.app.db_setCS(CSPointer, "IndexSortPriority", 0)
                    Else
                        Call cpCore.app.db_setCS(CSPointer, "IndexSortPriority", SortValue)
                        SortDirection = cpCore.app.db_GetCSInteger(CSPointer, "IndexSortDirection")
                    ...
                    End If
                    Call cpCore.app.db_setCS(CSPointer, "IndexSortDirection", SortDirection)
                    Call cpCore.app.db_csGoNext(CSPointer)
                Loop
            End If
            '
...
ErrorTrap:
        ...
        Private Function GetForm_CreateChildContent() As String
            ...
            If (cpCore.main_GetStreamText("Button") <> "") Then
                ...
                ' Process input
                '
                ParentContentID = cpCore.main_GetStreamInteger("ParentContentID")
                ParentContentName = Local_GetContentNameByID(ParentContentID)
                ChildContentName = cpCore.main_GetStreamText("ChildContentName")
                AddAdminMenuEntry = cpCore.main_GetStreamBoolean("AddAdminMenuEntry")
                '
                Call Stream.Add(SpanClassAdminSmall)
                ...
                Else
                    ...
                    If AddAdminMenuEntry Then
                        ...
                        If cpCore.app.db_csOk(CS) Then
                            MenuName = cpCore.main_GetCSText(CS, "name")
                        ...
                        Else
                            Call cpCore.main_CreateAdminMenu("Site Content", ChildContentName, ChildContentName, "", "")
                        End If
                    End If
            ...
            Stream.Add(cpCore.main_GetFormInputText("ChildContentName", ChildContentName, 1, 40))
            Call Stream.Add("<br><br>")
            '
            Call Stream.Add("Add Admin Menu Entry under Parent's Menu Entry<br>")
            Stream.Add(cpCore.main_GetFormInputCheckBox("AddAdminMenuEntry", AddAdminMenuEntry))
            Call Stream.Add("<br><br>")
            '
            ''Stream.Add( cpCore.main_GetFormInputHidden(RequestNameAdminForm, AdminFormToolCreateChildContent)
            Call Stream.Add("</SPAN>")
            '
            GetForm_CreateChildContent = OpenFormTable(ButtonList) & Stream.Text & CloseFormTable(ButtonList)
...
ErrorTrap:
        ...
        Private Function GetForm_ClearContentWatchLinks() As String
            ...
            If (cpCore.main_GetStreamText("Button") <> "") Then
                ...
                Call cpCore.app.executeSql("update ccContentWatch set Link=null;")
            ...
            Call Stream.Add("</span>")
            '
            GetForm_ClearContentWatchLinks = OpenFormTable(ButtonList) & Stream.Text & CloseFormTable(ButtonList)
            '
            Exit Function
            '
            ' ----- Error Trap
...
ErrorTrap:
        ...
        Private Function GetForm_SyncTables() As String
            ...
            Try
                Dim CSContent As Integer
                Dim CD As metaDataClass.CDefClass
                Dim Stream As New fastStringClass
                Dim ContentNameArray
                Dim ContentNameCount
                Dim TableName As String
                Dim ButtonList As String
                '
                ButtonList = ButtonCancel & "," & ButtonRun
                ...
                If (cpCore.main_GetStreamText("Button") <> "") Then
                    ...
                    CSContent = cpCore.app.db_csOpen("Content", , , , , ,, "id")
                    If cpCore.app.db_csOk(CSContent) Then
                        Do
                            CD = cpCore.app.metaData.getCdef(cpCore.app.db_GetCSInteger(CSContent, "id"))
                            TableName = CD.ContentTableName
                            Call Stream.Add("Synchronizing Content " & CD.Name & " to table " & TableName & "<br>")
                            Call cpCore.app.db_CreateSQLTable(CD.ContentDataSourceName, TableName)
                            If CD.fields.Count > 0 Then
                                For Each keyValuePair In CD.fields
                                    Dim field As metaDataClass.CDefFieldClass
                                    field = keyValuePair.Value
                                    Call Stream.Add("...Field " & field.nameLc & "<br>")
                                    Call cpCore.app.db_CreateSQLTableField(CD.ContentDataSourceName, TableName, field.nameLc, field.fieldTypeId)
                                Next
                            End If
                            cpCore.app.db_csGoNext(CSContent)
                        Loop While cpCore.app.db_csOk(CSContent)
                        ContentNameArray = cpCore.app.csv_GetCSRows(CSContent)
            ...
            If ActionCount > 0 Then
                For ActionPointer = 0 To ActionCount
                    ...
                    If Caption <> "" Then
                        ...
                        Panel = Panel & cpCore.main_GetFormInputRadioBox("DiagAction" & DiagActionCount, DiagActions(ActionPointer).Command, "")
                        Panel = Panel & "</td>"
        ...
        Private Function GetForm_Benchmark() As String
            ...
            If (cpCore.main_GetStreamText("Button") <> "") Then
                ...
                For TestPointer = 1 To 1000
                    TestTicks = GetTickCount
                    TestCopy = EncodeText(cpCore.main_GetContentFieldCount(1))
                ...
                For TestPointer = 1 To TestCount
                    '
                    TestTicks = GetTickCount
                    CS = cpCore.app.db_csOpen("Site Properties", , , , , , , PageSize, PageNumber)
                    OpenTicks = OpenTicks + GetTickCount - TestTicks
                    '
                    RecordCount = 0
                    Do While cpCore.app.db_csOk(CS)
                        '
                        TestTicks = GetTickCount
                        TestCopy = EncodeText(cpCore.app.db_GetCSField(CS, "Name"))
                        ReadTicks = ReadTicks + GetTickCount - TestTicks
                        '
                        TestTicks = GetTickCount
                        Call cpCore.app.db_csGoNext(CS)
                ...
                For TestPointer = 1 To TestCount
                    '
                    TestTicks = GetTickCount
                    CS = cpCore.app.db_csOpen("Site Properties", , , , , , "name", PageSize, PageNumber)
                    OpenTicks = OpenTicks + GetTickCount - TestTicks
                    '
                    RecordCount = 0
                    Do While cpCore.app.db_csOk(CS)
            ...
            '
            GetForm_Benchmark = OpenFormTable(ButtonList) & Stream.Text & CloseFormTable(ButtonList)
            Exit Function
            '
            ' ----- Error Trap
            '
ErrorTrap:
        ...
        Private Function Local_GetContentID(ByVal ContentName As String) As Integer
            ...
            dt = cpCore.app.executeSql("Select ID from ccContent where name=" & EncodeSQLText(ContentName))
...
ErrorTrap:
        ...
        Private Function Local_GetContentNameByID(ByVal ContentID As Integer) As String
            ...
            dt = cpCore.app.executeSql("Select name from ccContent where id=" & ContentID)
            If dt.Rows.Count > 0 Then
...
ErrorTrap:
        ...
        Private Function Local_GetContentTableName(ByVal ContentName As String) As String
            ...
            Dim RS As DataTable
            '
            Local_GetContentTableName = 0
            RS = cpCore.app.executeSql("Select ccTables.Name as TableName from ccContent Left Join ccTables on ccContent.ContentTableID=ccTables.ID where ccContent.name=" & EncodeSQLText(ContentName))
...
ErrorTrap:
        ...
        Private Function Local_GetContentDataSource(ByVal ContentName As String) As String
            ...
            SQL = "Select ccDataSources.Name" _
                    ...
                    & " where ccContent.name=" & EncodeSQLText(ContentName)
            RS = cpCore.app.executeSql(SQL)
        ...
        Private Function GetForm_DbSchema() As String
            ...
            Else
                ...
                Else
                    ...
                    arrayOfSchema = convertDataTabletoArray(RSSchema)
                    '
                ...
                On Error Resume Next
                '
                RSSchema = cpCore.app.getIndexSchemaData(TableName)
                If (Not isDataTableOk(RSSchema)) Then
                    '
                    ' ----- no result
                    '
                ...
                On Error Resume Next
                '
                RSSchema = cpCore.app.getColumnSchemaData(TableName)
                If ErrorNumber = 0 Then
                    Stream.Add(Now() & " GetSchema executed successfully<br>")
                Else
                    '
            ...
            Call Stream.Add("</SPAN>")
            '
            GetForm_DbSchema = OpenFormTable(ButtonList) & Stream.Text & CloseFormTable(ButtonList)
            '
            Exit Function
            '
            ' ----- Error Trap
...
ErrorTrap:
        ...
        Private Function GetForm_ConfigureEdit_CheckBox(ByVal Label As String, ByVal Value As String, ByVal Inherited As Boolean) As String
            ...
            Else
                GetForm_ConfigureEdit_CheckBox = GetForm_ConfigureEdit_CheckBox & cpCore.main_GetFormInputCheckBox(Label, Value)
            End If
        ...
        Private Function GetForm_DbIndex() As String
            ...
            '
            Button = cpCore.main_GetStreamText("Button")
            TableID = cpCore.main_GetStreamInteger("TableID")
            '
            ' Get Tablename and DataSource
            '
            CS = cpCore.main_OpenCSContentRecord("Tables", TableID, , , "Name,DataSourceID")
            If cpCore.app.db_csOk(CS) Then
                TableName = cpCore.main_GetCSText(CS, "name")
                DataSource = cpCore.main_GetCSLookup(CS, "DataSourceID")
            End If
            Call cpCore.app.db_csClose(CS)
            '
            If (TableID <> 0) And (TableID = cpCore.main_GetStreamInteger("previoustableid")) And (Button <> "") Then
                '
                ' Drop Indexes
                '
                Count = cpCore.main_GetStreamInteger("DropCount")
                If Count > 0 Then
                    For Pointer = 0 To Count - 1
                        If cpCore.main_GetStreamBoolean("DropIndex." & Pointer) Then
                            IndexName = cpCore.main_GetStreamText("DropIndexName." & Pointer)
                            GetForm_DbIndex = GetForm_DbIndex & "<br>Dropping index [" & IndexName & "] from table [" & TableName & "]"
                            Call cpCore.app.db_deleteSqlIndex("Default", TableName, IndexName)
                        End If
                    Next
                End If
                '
                ' Add Indexes
                '
                Count = cpCore.main_GetStreamInteger("AddCount")
                If Count > 0 Then
                    For Pointer = 0 To Count - 1
                        If cpCore.main_GetStreamBoolean("AddIndex." & Pointer) Then
                            'IndexName = cpCore.main_GetStreamText("AddIndexFieldName." & Pointer)
                            FieldName = cpCore.main_GetStreamText("AddIndexFieldName." & Pointer)
                            ...
                            Call cpCore.app.csv_CreateSQLIndex(DataSource, TableName, IndexName, FieldName)
                        End If
                    Next
                End If
            End If
            ...
            If TableID <> 0 Then
                ...
                '
                GetForm_DbIndex = GetForm_DbIndex & cpCore.main_GetFormInputHidden("PreviousTableID", TableID)
                '
                ' Drop Indexes
                '
                ...
                Else
                    ...
                    Rows = convertDataTabletoArray(RSSchema)
                    RowMax = UBound(Rows, 2)
                    For RowPointer = 0 To RowMax
                        IndexName = EncodeText(Rows(5, RowPointer))
                        If IndexName <> "" Then
                            GetForm_DbIndex = GetForm_DbIndex & StartTableRow()
                            Copy = cpCore.main_GetFormInputCheckBox("DropIndex." & RowPointer, False) _
                                    & cpCore.main_GetFormInputHidden("DropIndexName." & RowPointer, IndexName) _
                        ...
                        End If
                    Next
                    GetForm_DbIndex = GetForm_DbIndex & cpCore.main_GetFormInputHidden("DropCount", RowMax + 1)
                End If
                '
                ' Add Indexes
                '
                ...
                Else
                    ...
                    For RowPointer = 0 To RowMax
                        GetForm_DbIndex = GetForm_DbIndex & StartTableRow()
                        Copy = cpCore.main_GetFormInputCheckBox("AddIndex." & RowPointer, False) _
                                & cpCore.main_GetFormInputHidden("AddIndexFieldName." & RowPointer, Rows(3, RowPointer)) _
                        ...
                        TableRowEven = Not TableRowEven
                    Next
                    GetForm_DbIndex = GetForm_DbIndex & cpCore.main_GetFormInputHidden("AddCount", RowMax + 1)
                End If
                '
                ' Spacers
                '
            ...
            GetForm_DbIndex = OpenFormTable(ButtonList) & GetForm_DbIndex & CloseFormTable(ButtonList)
            '
            Exit Function
            '
            ' ----- Error Trap
...
ErrorTrap:
        ...
        Private Function GetForm_ContentDbSchema() As String
            ...
            TableName = ""
            Do While cpCore.app.db_csOk(CS)
                If TableName <> cpCore.main_GetCSText(CS, "TableName") Then
                    TableName = cpCore.main_GetCSText(CS, "TableName")
                ...
                GetForm_ContentDbSchema = GetForm_ContentDbSchema & GetTableCell(cpCore.main_GetCSText(CS, "FieldName"), , , TableEvenRow)
                GetForm_ContentDbSchema = GetForm_ContentDbSchema & GetTableCell(cpCore.main_GetCSText(CS, "FieldType"), , , TableEvenRow)
            ...
            GetForm_ContentDbSchema = (OpenFormTable(ButtonList)) & GetForm_ContentDbSchema & (CloseFormTable(ButtonList))
            '
            Exit Function
            '
            ' ----- Error Trap
...
ErrorTrap:
        ...
        Private Function GetForm_LogFiles_Details() As String
            ...
            '
            CurrentPath = cpCore.main_GetStreamText("SetPath")
            If CurrentPath = "" Then
                CurrentPath = "\"
            ...
            '
            '
            If cpCore.main_GetStreamText("SourceFile") <> "" Then
                '
                ' Return the content of the file
                '

                Call cpCore.setResponseContentType("text/text")
                Call cpCore.writeAltBuffer(cpCore.app.appRootFiles.ReadFile(cpCore.main_GetStreamText("SourceFile")))
                Call cpCore.main_CloseStream()
                'GetForm_LogFiles_Details = cpCore.app.publicFiles.ReadFile(cpCore.main_GetStreamText("SourceFile"))
            Else
                ...
                If CurrentPath <> ParentPath Then
                    FileSize = ""
                    FileDate = ""
                    GetForm_LogFiles_Details = GetForm_LogFiles_Details & GetForm_LogFiles_Details_GetRow("<A href=""" & cpCore.main_ServerPage & "?SetPath=" & ParentPath & """>" & FolderOpenImage & "</A>", "<A href=""" & cpCore.main_ServerPage & "?SetPath=" & ParentPath & """>" & ParentPath & "</A>", FileSize, FileDate, RowEven)
                End If
                '
                ' Sub-Folders
                '
                ...
                If SourceFolders <> "" Then
                    ...
                    For FolderPointer = 0 To FolderCount - 1
                        ...
                        If FolderLine <> "" Then
                            ...
                            GetForm_LogFiles_Details = GetForm_LogFiles_Details & GetForm_LogFiles_Details_GetRow("<A href=""" & cpCore.main_ServerPage & "?SetPath=" & CurrentPath & "\" & FolderName & """>" & FolderClosedImage & "</A>", "<A href=""" & cpCore.main_ServerPage & "?SetPath=" & CurrentPath & "\" & FolderName & """>" & FolderName & "</A>", FileSize, FileDate, RowEven)
                        End If
                    Next
                End If
                '
                ' Files
                '
                SourceFolders = cpCore.app.appRootFiles.convertFileINfoArrayToParseString(cpCore.app.appRootFiles.GetFolderFiles(StartPath & CurrentPath))
                If SourceFolders = "" Then
                    FileSize = ""
                    FileDate = ""
                ...
                Else
                    ...
                    For FolderPointer = 0 To FolderCount - 1
                        ...
                        If FolderLine <> "" Then
                            ...
                            QueryString = cpCore.main_RefreshQueryString
                            ...
                            CellCopy = "<A href=""" & cpCore.main_ServerPath & "?" & QueryString & """ target=""_blank"">" & Filename & "</A>"
        ...
        '=============================================================================
        '
        Function GetForm_LogFiles_Details_GetRow(ByVal Cell0 As String, ByVal Cell1 As String, ByVal Cell2 As String, ByVal Cell3 As String, ByVal RowEven As Boolean)
            '
            Dim ClassString
            '
...
ErrorTrap:
        ...
        Private Function GetForm_Restart() As String
            ...
            If Not cpCore.user_isAdmin Then
                ...
                '
            ElseIf (cpCore.main_GetStreamText("button")) <> ButtonRestartContensiveApplication Then
                '
                ' First pass, initialize
                '
            Else
            ...
            Call Stream.Add("</SPAN>")
            '
            GetForm_Restart = OpenFormTable(ButtonList) & Stream.Text & CloseFormTable(ButtonList)
            '
            Exit Function
            '
            ' ----- Error Trap
...
ErrorTrap:
        ...
        '
        '
        Private Function GetCDef(ByVal ContentName As String) As metaDataClass.CDefClass
            On Error GoTo ErrorTrap
            '
            GetCDef = cpCore.app.metaData.getCdef(ContentName)
            '
            Exit Function
            '
            ' ----- Error Trap
...
ErrorTrap:
        ...
        '    '
        '    CS = cpCore.app.db_openCsSql_rev("default", "select * from ccContent where name=" & encodeSQLText(ContentName))
        ...
        '            ' Load the Content's parent in first, then overlay it's field over the parents
        '            '
        '            CSParent = cpCore.app.db_openCsSql_rev("default", "select name from ccContent where id=" & ParentID)
        '            If cpCore.asv.csv_IsCSOK(CSParent) Then
        '                ParentContentName = cpCore.main_GetCSText(CS, "name")
        '                GetCDefFromDb = GetCDefFromDb(ParentContentName)
        '            End If
        '            Call cpCore.app.db_closeCS(CSParent)
        '        End If
        '        '
        '        ' Store the CDef fields
        '        '
        '        GetCDefFromDb.ActiveOnly = cpCore.app.db_GetCS(CS, "activeonly")
        '        GetCDefFromDb.AdminColumns.Count = cpCore.app.db_GetCS(CS, "activeonly")
        '    End If
        ...
        Private Function GetForm_LoadTemplates() As String
            ...
            '
            AllowBodyHTML = cpCore.main_GetStreamBoolean("AllowBodyHTML")
            AllowScriptLink = cpCore.main_GetStreamBoolean("AllowScriptLink")
            AllowImageImport = cpCore.main_GetStreamBoolean("AllowImageImport")
            AllowStyleImport = cpCore.main_GetStreamBoolean("AllowStyleImport")
            '
            Stream.Add(GetTitle("Load Templates", "This tool creates template records from the HTML files in the root folder of the site."))
            '
            If (cpCore.main_GetStreamText("button")) <> ButtonImportTemplates Then
                '
                ' First pass, initialize
                '
            Else
                ...
                Call Stream.Add(ImportTemplates(Replace(cpCore.cluster.config.clusterPhysicalPath & cpCore.app.config.appRootPath & cpCore.app.RootPath, "/", "\"), "", AllowBodyHTML, AllowScriptLink, AllowImageImport, AllowStyleImport))
            ...
            Stream.Add("<br>" & cpCore.main_GetFormInputCheckBox("AllowBodyHTML", AllowBodyHTML) & " Update/Import Soft Templates from the Body of .HTM and .HTML files")
            Stream.Add("<br>" & cpCore.main_GetFormInputCheckBox("AllowScriptLink", AllowScriptLink) & " Update/Import Hard Templates with links to .ASP and .ASPX scripts")
            Stream.Add("<br>" & cpCore.main_GetFormInputCheckBox("AllowImageImport", AllowImageImport) & " Update/Import image links (.GIF,.JPG,.PDF ) into the resource library")
            Stream.Add("<br>" & cpCore.main_GetFormInputCheckBox("AllowStyleImport", AllowStyleImport) & " Import style sheets (.CSS) to Dynamic Styles")
            Call Stream.Add("</SPAN>")
            '
            ButtonList = ButtonCancel & "," & ButtonImportTemplates
            GetForm_LoadTemplates = OpenFormTable(ButtonList) & Stream.Text & CloseFormTable(ButtonList)
            '
            Exit Function
            '
            ' ----- Error Trap
...
ErrorTrap:
        ...
        Private Function ImportTemplates(ByVal FileRootPath As String, ByVal AppPath As String, ByVal AllowBodyHTML As Boolean, ByVal AllowScriptLink As Boolean, ByVal AllowImageImport As Boolean, ByVal AllowStyleImport As Boolean) As String
            ...
            'dim buildversion As String
            '
            FileList = cpCore.app.appRootFiles.convertFileINfoArrayToParseString(cpCore.app.appRootFiles.GetFolderFiles(FileRootPath & AppPath))
            ...
            For Ptr = 0 To UBound(Files)
                ...
                If AllowScriptLink And (InStr(1, Filename, ".asp", vbTextCompare) <> 0) And (Mid(Filename, 1, 1) <> "_") Then
                    ...
                    End If
                    '
                    CS = cpCore.app.db_csOpen("Page Templates", "Link=" & EncodeSQLText(Link))
                    If Not cpCore.app.db_csOk(CS) Then
                        Call cpCore.app.db_csClose(CS)
                        CS = cpCore.app.db_csInsertRecord("Page Templates")
                        Call cpCore.app.db_setCS(CS, "Link", Link)
                    End If
                    If cpCore.app.db_csOk(CS) Then
                        Call cpCore.app.db_setCS(CS, "name", TemplateName)
                    End If
                    Call cpCore.app.db_csClose(CS)
                ElseIf AllowBodyHTML And (InStr(1, Filename, ".htm", vbTextCompare) <> 0) And (Mid(Filename, 1, 1) <> "_") Then
                    ...
                    ' HTML, import body
                    '
                    PageSource = cpCore.app.appRootFiles.ReadFile(Filename)
                    ...
                    If True Then
                        ...
                        '
                        CS = cpCore.app.db_csOpen("Page Templates", "Source=" & EncodeSQLText(Link))
                        If Not cpCore.app.db_csOk(CS) Then
                            Call cpCore.app.db_csClose(CS)
                            CS = cpCore.app.db_csInsertRecord("Page Templates")
                            Call cpCore.app.db_setCS(CS, "Source", Link)
                            Call cpCore.app.db_setCS(CS, "name", TemplateName)
                        End If
                        If cpCore.app.db_csOk(CS) Then
                            Call cpCore.app.db_setCS(CS, "Link", "")
                            Call cpCore.app.db_setCS(CS, "bodyhtml", PageSource)
                        End If
                        Call cpCore.app.db_csClose(CS)
                    End If
                    '
                ...
                ElseIf AllowStyleImport And (InStr(1, Filename, ".css", vbTextCompare) <> 0) And (Mid(Filename, 1, 1) <> "_") Then
                    ...
                    Copy = cpCore.app.appRootFiles.ReadFile(DynamicFilename)
                    ...
                    Copy = Copy _
                            ...
                            & vbCrLf _
                            & vbCrLf
                    Copy = Copy & RemoveStyleTags(cpCore.app.appRootFiles.ReadFile(Filename))
                    Call cpCore.app.appRootFiles.SaveFile(DynamicFilename, Copy)
                End If
            Next
            '
...
ErrorTrap:
        ...
        '
        '
        Private Function LoadCDef(ByVal ContentName As String) As metaDataClass.CDefClass
            On Error GoTo ErrorTrap
            '
            Dim SQL As String
            Dim CS As Integer
            ...
            Dim ParentID As Integer
            '
            CSContent = cpCore.app.db_csOpen("Content", "name=" & EncodeSQLText(ContentName))
            If cpCore.app.db_csOk(CSContent) Then
                '
                ' Start with parent CDef
                '
                ParentID = cpCore.app.db_GetCSInteger(CSContent, "parentID")
                If ParentID <> 0 Then
                ...
                '
                With LoadCDef
                    CS = cpCore.app.db_csOpen("Content Fields", "contentid=" & ContentID)
                    Do While cpCore.app.db_csOk(CS)
                        Select Case UCase(cpCore.main_GetCSText(CS, "name"))
                            Case "NAME"
                                .Name = ""
                        End Select
                        Call cpCore.app.db_csGoNext(CS)
...
ErrorTrap:
        ...
        Private Function GetForm_FindAndReplace() As String
            ...
            Dim Button As String
            Dim ReplaceRows As String
            Dim FindRows As String
            ...
            If Button = ButtonFindAndReplace Then
                RowCnt = cpCore.main_GetStreamInteger("CDefRowCnt")
                If RowCnt > 0 Then
                    For RowPtr = 0 To RowCnt - 1
                        If cpCore.main_GetStreamBoolean("Cdef" & RowPtr) Then
                            lcName = LCase(cpCore.main_GetStreamText("CDefName" & RowPtr))
            ...
            ' Display form
            '
            FindRows = cpCore.main_GetStreamInteger("SQLRows")
            If FindRows = 0 Then
                FindRows = cpCore.main_GetMemberProperty("FindAndReplaceFindRows", "1")
            Else
                Call cpCore.main_SetMemberProperty("FindAndReplaceFindRows", CStr(FindRows))
            End If
            ReplaceRows = cpCore.main_GetStreamInteger("ReplaceRows")
            If ReplaceRows = 0 Then
                ReplaceRows = cpCore.main_GetMemberProperty("FindAndReplaceReplaceRows", "1")
            Else
                Call cpCore.main_SetMemberProperty("FindAndReplaceReplaceRows", CStr(ReplaceRows))
            End If
            '
            ...
            Do While cpCore.app.db_csOk(CS)
                ...
                If IsDeveloper Or (lcName = "page content") Or (lcName = "copy content") Or (lcName = "page templates") Then
                    ...
                    If InStr(1, "," & CDefList & ",", "," & RecordName & ",") <> 0 Then
                        TopHalf = TopHalf & "<div>" & cpCore.main_GetFormInputCheckBox("Cdef" & RowPtr, True) & cpCore.main_GetFormInputHidden("CDefName" & RowPtr, RecordName) & "&nbsp;" & cpCore.main_GetCSText(CS, "Name") & "</div>"
                    Else
                        BottomHalf = BottomHalf & "<div>" & cpCore.main_GetFormInputCheckBox("Cdef" & RowPtr, False) & cpCore.main_GetFormInputHidden("CDefName" & RowPtr, RecordName) & "&nbsp;" & cpCore.main_GetCSText(CS, "Name") & "</div>"
                    End If
                End If
                Call cpCore.app.db_csGoNext(CS)
                RowPtr = RowPtr + 1
            Loop
            Call cpCore.app.db_csClose(CS)
            Stream.Add(TopHalf & BottomHalf & cpCore.main_GetFormInputHidden("CDefRowCnt", RowPtr))
                '
...
ErrorTrap:
            ...
            Private Function GetForm_IISReset() As String
                ...
                ' Display form
                '
                GetForm_IISReset = OpenFormTable(ButtonCancel & "," & ButtonIISReset) & s.Text & CloseFormTable(ButtonCancel & "," & ButtonIISReset)
                Exit Function
                '
                ' ----- Error Trap
                '
ErrorTrap:
            ...
            Private Function GetForm_CreateGUID() As String
                ...
                Call s.Add(cpCore.main_GetFormInputText("GUID", Guid.NewGuid().ToString, 1, 80))
                'Call s.Add("<span style=""border:inset; padding:4px; background-color:white;"">" & Guid.NewGuid.ToString() & "</span>")
                'End If
                '
                ' Display form
                '
                GetForm_CreateGUID = OpenFormTable(ButtonCancel & "," & ButtonCreateGUID) & s.Text & CloseFormTable(ButtonCancel & "," & ButtonCreateGUID)
                Exit Function
                '
                ' ----- Error Trap
                '
