...
Namespace Contensive.Core
    Public Class coreDbClass
        ...
        Public Function getDataSourceId(ByVal DataSourceName As String) As Integer
            ...
            Try
                Dim normalizedDataSourceName As String = normalizeDataSourceKey(DataSourceName)
        ...
        ''' <param name="DataSourceName"></param>
        ''' <returns></returns>
        Friend Function normalizeDataSourceKey(DataSourceName As String) As String
            ...
            Try
                ...
                Else
                    ...
                    Else
                        ...
                        Using dt As DataTable = executeSql_internal(sql, defaultDataSourceConnString, 0, 1)
        ...
        ''' <param name="maxRecords"></param>
        ''' <returns></returns>
        Private Function executeSql_internal(ByVal sql As String, ByVal connString As String, ByVal startRecord As Integer, ByVal maxRecords As Integer) As DataTable
            '
            ' REFACTOR
        ...
        Public Function cs_openContentRecord(ByVal ContentName As String, ByVal RecordID As Integer, Optional ByVal MemberID As Integer = SystemMemberID, Optional ByVal WorkflowAuthoringMode As Boolean = False, Optional ByVal WorkflowEditingMode As Boolean = False, Optional ByVal SelectFieldList As String = "") As Integer
            ...
            Try
                If (RecordID <= 0) Then
                    Throw New ArgumentException("recordId is not valie [" & RecordID & "]")
                Else
