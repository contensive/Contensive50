...
ErrorTrap:
        ...
        Private Sub ProcessEmail_GroupEmail(ByVal ignore_buildversion As String)
            ...
            If cpCore.db.csOk(CSEmail) Then
                ...
                '
                Do While cpCore.db.csOk(CSEmail)
                    ...
                    '
                    Call cpCore.db.csSet(CSEmail, "sent", True)
                    Call cpCore.db.csSave2(CSEmail)
                    '
                    ' Create Drop Record
                    '
                    CSDrop = cpCore.db.csInsertRecord("Email Drops", EmailMemberID)
                    If cpCore.db.csOk(CSDrop) Then
                        ...
                        End If
                        Call cpCore.db.csSet(CSDrop, "Name", "Drop " & EmailDropID & " - Scheduled for " & FormatDateTime(ScheduleDate, vbShortDate) & " " & FormatDateTime(ScheduleDate, vbShortTime))
                        Call cpCore.db.csSet(CSDrop, "EmailID", emailID)
                        'Call cpCore.asv.csv_SetCSField(CSDrop, "CreatedBy", EmailMemberID)
                    End If
                    Call cpCore.db.csClose(CSDrop)
                    '
                    ' Select the people
                    '
                    If False Then
                    ...
                    Do While cpCore.db.csOk(CSPeople)
                        ...
                        Else
                            EmailStatusList = EmailStatusList & SendEmailRecord(PeopleID, emailID, Date.MinValue, EmailDropID, BounceAddress, EmailFrom, EmailTemplate, EmailFrom, EmailSubject, cpCore.db.csGet(CSEmail, "CopyFilename"), cpCore.db.csGetBoolean(CSEmail, "AllowSpamFooter"), cpCore.db.csGetBoolean(CSEmail, "AddLinkEID"), "") & BR
                    ...
                    Call SendConfirmationEmail(ConfirmationMemberID, EmailDropID, EmailTemplate, EmailAddLinkEID, PrimaryLink, EmailSubject, EmailCopy, "", EmailFrom, EmailStatusList)
                    ...
                    '
                    Call cpCore.db.csGoNext(CSEmail)
                Loop
            End If
...
ErrorTrap:
        ...
        Private Sub ProcessEmail_ConditionalEmail(ByVal ignore_buildversion As String, ByVal IsNewHour As Boolean, ByVal IsNewDay As Boolean)
            ...
            If IsNewDay Then
                ...
                Do While cpCore.db.csOk(CSEmailBig)
                    ...
                    If cpCore.db.csOk(CSEmail) Then
                        ...
                        Call SendConfirmationEmail(ConfirmationMemberID, EmailDropID, EmailTemplate, EmailAddLinkEID, "", EmailSubject, EmailCopy, "", FromAddress, EmailStatus & "<BR>")
                    End If
                    Call cpCore.db.csClose(CSEmail)
                    Call cpCore.db.csGoNext(CSEmailBig)
                Loop
                Call cpCore.db.csClose(CSEmailBig)
            End If
            '
        ...
        Private Function SendEmailRecord(ByVal MemberID As Integer, ByVal emailID As Integer, ByVal DateBlockExpires As Date, ByVal EmailDropID As Integer, ByVal BounceAddress As String, ByVal ReplyToAddress As String, ByVal EmailTemplate As String, ByVal FromAddress As String, ByVal EmailSubject As String, ByVal EmailBody As String, ByVal AllowSpamFooter As Boolean, ByVal EmailAllowLinkEID As Boolean, ByVal emailStyles As String) As String
            ...
            Try
                ...
                If cpCore.db.csOk(CSLog) Then
                    Call cpCore.db.csSet(CSLog, "Name", "Sent " & CStr(Now()))
                    Call cpCore.db.csSet(CSLog, "EmailDropID", EmailDropID)
                    Call cpCore.db.csSet(CSLog, "EmailID", emailID)
                    Call cpCore.db.csSet(CSLog, "MemberID", MemberID)
                    Call cpCore.db.csSet(CSLog, "LogType", EmailLogTypeDrop)
                    Call cpCore.db.csSet(CSLog, "DateBlockExpires", DateBlockExpires)
                    Call cpCore.db.csSet(CSLog, "SendStatus", "Send attempted but not completed")
                    If True Then
                        Call cpCore.db.csSet(CSLog, "fromaddress", FromAddress)
                        Call cpCore.db.csSet(CSLog, "Subject", EmailSubject)
                    End If
                    Call cpCore.db.csSave2(CSLog)
                    '
                    ' Get the Template
                    '
                    ...
                    If cpCore.db.csOk(CSPeople) Then
                        ...
                        EmailBodyEncoded = cpCore.html.encodeContent10(EmailBodyEncoded, MemberID, "", 0, 0, False, EmailAllowLinkEID, True, True, False, True, ClickFlagQuery, PrimaryLink, True, 0, "", CPUtilsClass.addonContext.ContextEmail, True, Nothing, False)
                        ...
                        EmailSubjectEncoded = cpCore.html.encodeContent10(EmailSubjectEncoded, MemberID, "", 0, 0, True, False, False, False, False, True, "", PrimaryLink, True, 0, "", CPUtilsClass.addonContext.ContextEmail, True, Nothing, False)
                        ...
                        Else
                            ...
                            EmailTemplateEncoded = cpCore.html.encodeContent10(EmailTemplate, MemberID, "", 0, 0, False, EmailAllowLinkEID, True, True, False, True, ClickFlagQuery, PrimaryLink, True, 0, "", CPUtilsClass.addonContext.ContextEmail, True, Nothing, False)
                        ...
                        '
                        EmailBodyEncoded = genericController.vbReplace(EmailBodyEncoded, rnEmailBlockRecipientEmail, "", 1, 99, vbTextCompare)
                        ...
                        ' ----- Log the send
                        '
                        Call cpCore.db.csSet(CSLog, "SendStatus", EmailStatus)
                        If True Then
        ...
        Private Function GetEmailTemplate(ByVal EmailTemplateID As Integer) As String
            ...
            If EmailTemplateID <> 0 Then
                ...
                If cpCore.db.csOk(CS) Then
                    GetEmailTemplate = cpCore.db.csGet(CS, "BodyHTML")
                End If
        ...
        Private Sub SendConfirmationEmail(ByVal ConfirmationMemberID As Integer, ByVal EmailDropID As Integer, ByVal EmailTemplate As String, ByVal EmailAllowLinkEID As Boolean, ByVal PrimaryLink As String, ByVal EmailSubject As String, ByVal EmailCopy As String, ByVal emailStyles As String, ByVal EmailFrom As String, ByVal EmailStatusList As String)
            Try
                ...
                If cpCore.db.csOk(CSPeople) Then
                    ...
                    EmailSubject = cpCore.html.encodeContent10(EmailSubject, ConfirmationMemberID, "", 0, 0, True, False, False, False, False, True, "", "http://" & GetPrimaryDomainName(), True, 0, "", CPUtilsClass.addonContext.ContextEmail, True, Nothing, False)
                    ...
                    EmailBody = cpCore.html.encodeContent10(EmailCopy, ConfirmationMemberID, "", 0, 0, False, EmailAllowLinkEID, True, True, False, True, "", "http://" & GetPrimaryDomainName(), True, 0, "", CPUtilsClass.addonContext.ContextEmail, True, Nothing, False)
                    ...
                    Else
                        ...
                        WorkingTemplate = cpCore.html.encodeContent10(WorkingTemplate, ConfirmationMemberID, "", 0, 0, False, EmailAllowLinkEID, True, True, False, True, "", "http://" & GetPrimaryDomainName(), True, 0, "", CPUtilsClass.addonContext.ContextEmail, True, Nothing, False)
                    ...
                    Call cpCore.email.send(cpCore.db.csGetText(CSPeople, "Email"), EmailFrom, "Email confirmation from " & GetPrimaryDomainName(), ConfirmBody, "", "", "", True, True, 0)
                End If
                Call cpCore.db.csClose(CSPeople)
            Catch ex As Exception
