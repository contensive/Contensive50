...
Namespace Contensive.Core
    '<ComVisible(True)> _
    '<ProgId("ipDaemonClass")> _
    '<ComClass(ipDaemonClass.ClassId, ipDaemonClass.InterfaceId, ipDaemonClass.EventsId)> _
    Public Class ipDaemonClass
        '
        '#Region "COM GUIDs"
        '        ' These  GUIDs provide the COM identity for this class 
        '        ' and its COM interfaces. If you change them, existing 
        '        ' clients will no longer be able to access the class.
        '        Public Const ClassId As String = "8847AE21-77AA-45D2-8DEA-BC1C166AD619"
        '        Public Const InterfaceId As String = "A54E0C35-A57C-49C0-951F-A7F69C03D22B"
        '        Public Const EventsId As String = "56829A2B-3255-4541-96D7-1CBAB563A91B"
        '#End Region
        '
