                    ...
                    if ((appConfig.appStatus == Models.Context.serverConfigModel.appStatusEnum.OK) && (appConfig.appMode == Models.Context.serverConfigModel.appModeEnum.normal)) {
                        ...
                        if (cp != null) {
                            if (true) {
                                ...
                                if (!collectionController.UpgradeLocalCollectionRepoFromRemoteCollectionRepo(cp.core, ref ErrorMessage, ref ignoreRefactorText, ref ignoreRefactorBoolean, false, ref nonCriticalErrorList)) {
                                ...
                                //
                                collectionController.installCollectionFromRemoteRepo(cp.core, CoreCollectionGuid, ref ErrorMessage, "", false, ref nonCriticalErrorList);
                                //
