        ...
        public static void upgrade(coreClass cpcore, bool isNewBuild) {
            try {
                if (cpcore.doc.upgradeInProgress) {
                    ...
                    addonInstallClass.installBaseCollection(cpcore, isNewBuild, nonCriticalErrorList);
                    // 
                    //  -- Update server config file
                    logController.appendInstallLog(cpcore, "Update configuration file");
                    if (!cpcore.serverConfig.appConfig.appStatus.Equals(serverConfigModel.appStatusEnum.OK)) {
                    ...
                    if ((cpcore.serverConfig.appConfig.domainList.Count > 0)) {
                        primaryDomain = cpcore.serverConfig.appConfig.domainList;
                        0;
                    }
                    ...
                    if (isNewBuild) {
                        ...
                        if ((dt.Rows.Count == 0)) {
                            string SQL = ("" + ("insert into ccmembers" + (" (active,contentcontrolid,name,firstName,username,password,developer,admin,AllowToolsPanel,AllowBulkE" +
                            "mail,AutoLogin)" + (" values (1," 
                                        + (cid + (",\'root\',\'root\',\'root\',\'contensive\',1,1,1,1,1)" + ("" + ("" + ""))))))));
                    ...
                    // ---------------------------------------------------------------------
                    // 
                    if ((DataBuildVersion < cpcore.codeVersion())) {
                        // 
                        //  -- data updates
                        logController.appendInstallLog(cpcore, ("Run database conversions, DataBuildVersion [" 
                                        + (DataBuildVersion + ("], software version [" 
                                        + (cpcore.codeVersion() + "]")))));
                    ...
                    Models.Entity.addonModel defaultRouteAddon = Models.Entity.addonModel.create(cpcore, defaultRouteAddonId);
                    if ((defaultRouteAddon == null)) {
                        defaultRouteAddon = Models.Entity.addonModel.create(cpcore, addonGuidPageManager);
                        if (defaultRouteAddon) {
                            IsNot;
                            null;
                    ...
                    if (isNewBuild) {
                        ...
                        // 
                        //  -- primary domain
                        Models.Entity.domainModel domain = Models.Entity.domainModel.createByName(cpcore, primaryDomain, new List<string>());
                        if ((domain == null)) {
                            domain = Models.Entity.domainModel.add(cpcore, new List<string>());
                            domain.name = primaryDomain;
                        }
                        
                        // 
                        //  -- Landing Page
                        Models.Entity.pageContentModel landingPage = pageContentModel.create(cpcore, DefaultLandingPageGuid, new List<string>());
                        if ((landingPage == null)) {
                        ...
                        // 
                        //  -- default template
                        Models.Entity.pageTemplateModel defaultTemplate = pageTemplateModel.createByName(cpcore, "Default", new List<string>());
                                        ...
                                        if ((genericController.vbLCase(Doc.DocumentElement.Name) == "collectionlist")) {
                                            ...
                                            if ((dt.Rows.Count > 0)) {
                                                ...
                                                for (rowptr = 0; (rowptr 
                                                    ...
                                                    logController.appendInstallLog(cpcore, ("...checking collection [" 
                                                                    + (Collectionname + ("], guid [" 
                                                                    + (CollectionGuid + "]")))));
                                                    if ((CollectionGuid != "{7c6601a7-9d52-40a3-9570-774d0d43d758}")) {
                                                        ...
                                                        DateTime LastChangeDate = genericController.EncodeDate(dt.Rows[rowptr].Item["LastChangeDate"]);
                                                        Doc.DocumentElement.MinValue;
                                                        // 
                                                        //  app version has no lastchangedate
                                                        // 
                                                        upgradeCollection = true;
                                                        appendUpgradeLog(cpcore, cpcore.serverConfig.appConfig.name, "upgrade", ("Upgrading collection " 
                                                                        + (dt.Rows[rowptr].Item["name"].ToString + " because the collection installed in the application has no LastChangeDate. It may have been installe" +
                                                                        "d manually.")));
                                                    }
                                                    else {
                                                        // 
                                                        ...
                                                        foreach (XmlNode LocalListNode in Doc.DocumentElement.ChildNodes) {
                                                            ...
                                                            if ((CollectionGuid == genericController.vbLCase(LocalGuid))) {
                                                                ...
                                                                if ((LocalLastChangeDate > LastChangeDate)) {
                                                                    appendUpgradeLog(cpcore, cpcore.serverConfig.appConfig.name, "upgrade", ("Upgrading collection " 
                                                                                    + (dt.Rows[rowptr].Item["name"].ToString() + " because the collection in the local server store has a newer LastChangeDate than the collection inst" +
                                                                                    "alled on this application.")));
                                                                    upgradeCollection = true;
                                                                }
                                                            ...
                                                            if ((ErrorMessage == "")) {
                                                                if (!localCollectionFound) {
                                                                    logController.appendInstallLog(cpcore, ("...site collection [" 
                                                                                    + (Collectionname + "] not found in local collection, call UpgradeAllAppsFromLibCollection2 to install it.")));
                                                                    bool addonInstallOk = addonInstallClass.installCollectionFromRemoteRepo(cpcore, CollectionGuid, ErrorMessage, "", isNewBuild, nonCriticalErrorList);
                                                                    if (!addonInstallOk) {
                                                                        // 
                                                                        //  this may be OK so log, but do not call it an error
                                                                        // 
                                                                        logController.appendInstallLog(cpcore, ("...site collection [" 
                                                                                        + (Collectionname + ("] not found in collection Library. It may be a custom collection just for this site. Collection guid " +
                                                                                        "[" 
                                                                                        + (CollectionGuid + "]")))));
                                                                    }
                                                                    
                                                                }
                                                                else if (upgradeCollection) {
                                                                    logController.appendInstallLog(cpcore, "...upgrading collection");
                                                                    addonInstallClass.installCollectionFromLocalRepo(cpcore, CollectionGuid, cpcore.codeVersion, ErrorMessage, "", isNewBuild, nonCriticalErrorList);
                                                                }
                                                    ...
                                                    // With...
                                                    ((Exception)(ex9));
                                                    handleClassException(cpcore, ex9, cpcore.serverConfig.appConfig.name, "upgrade");
                                                    //  "upgrade2")
                                                    try {
                                                        // 
                                                        //  done
                                                    ...
                                                    // 
                                                    // 
                                                    VerifyAdminMenus(((coreClass)(cpCore)), ((string)(DataBuildVersion)));
                                                    try {
                                                        DataTable dt;
                                                        // 
                                                        ...
                                                        if ((dt.Rows.Count > 0)) {
                                                            ...
                                                            for (rowptr = 0; (rowptr 
                                                                ...
                                                                if ((FieldNew == FieldLast)) {
                                                                    ...
                                                                    cpCore.db.executeQuery(("Update ccMenuEntries set active=0 where ID=" 
                                                                                    + (FieldRecordID + ";")));
                                                                }
                                                    ...
                                                    // 
                                                    VerifyRecord(((coreClass)(cpcore)), ((string)(ContentName)), ((string)(Name)), Optional, CodeFieldNameAsString=, Optional, CodeAsString=, Optional, InActiveAsBoolean=False);
                                                    try {
                                                        bool Active;
                                                        DataTable dt;
                                                        string sql1;
                                                        ...
                                                        int cid = cdef.Id;
                                                        // 
                                                        dt = cpcore.db.executeQuery(("SELECT ID FROM " 
                                                                        + (tableName + (" WHERE NAME=" 
                                                                        + (cpcore.db.encodeSQLText(Name) + ";")))));
                                                        if ((dt.Rows.Count == 0)) {
                                                            sql1 = ("insert into " 
                                                                        + (tableName + " (contentcontrolid,createkey,active,name"));
                                                            sql2 = (") values (" 
                                                                        + (cid + (",0," 
                                                                        + (cpcore.db.encodeSQLBoolean(Active) + ("," + cpcore.db.encodeSQLText(Name))))));
                                                            sql3 = ")";
                                                            if ((CodeFieldName != "")) {
                                                                ("," + CodeFieldName);
                                                                ("," + Code);
                                                    ...
                                                    // ========================================================================
                                                    // 
                                                    Upgrade_Conversion(((coreClass)(cpCore)), ((string)(DataBuildVersion)));
                                                    try {
                                                        int CID;
                                                        // 
                                                        // ---------------------------------------------------------------------
                                                        ...
                                                        if (false) {
                                                            ...
                                                            if ((CID != 0)) {
                                                                ...
                                                                cpCore.db.executeQuery(("delete from cccontent where id in (select c.id from cccontent c left join cctables t on t.id=c.conten" +
                                                                    "ttableid where t.name=\'ccAggregateFunctions\' and c.id<>" 
                                                                                + (CID + ")")));
                                                            }
                                                    ...
                                                    // =========================================================================================
                                                    // 
                                                    VerifyTableCoreFields(((coreClass)(cpCore)));
                                                    try {
                                                        // 
                                                        int IDVariant;
                                                        bool Active;
                                                        ...
                                                        // 
                                                        SQL = ("SELECT ccDataSources.Name as DataSourceName, ccDataSources.ID as DataSourceID, ccDataSources.Active a" +
                                                        "s DataSourceActive, ccTables.Name as TableName" + (" FROM ccTables LEFT JOIN ccDataSources ON ccTables.DataSourceID = ccDataSources.ID" + (" Where (((ccTables.active) <> 0))" + " ORDER BY ccDataSources.Name, ccTables.Name;")));
                                                    ...
                                                    // =========================================================================================
                                                    // 
                                                    VerifyScriptingRecords(((coreClass)(cpCore)));
                                                    try {
                                                        // 
                                                    ...
                                                    // =========================================================================================
                                                    // 
                                                    VerifyLanguageRecords(((coreClass)(cpCore)));
                                                    try {
                                                        // 
                                                    ...
                                                    // 
                                                    VerifyLibraryFolders(((coreClass)(cpCore)));
                                                    try {
                                                        DataTable dt;
                                                        // 
                                                    ...
                                                    // =============================================================================
                                                    // 
                                                    ((int)(GetIDBYName(((coreClass)(cpCore)), ((string)(TableName)), ((string)(RecordName)))));
                                                    int returnid = 0;
                                                    try {
                                                        // 
                                                        DataTable rs;
                                                        // 
                                                        rs = cpCore.db.executeQuery(("Select ID from " 
                                                                        + (TableName + (" where name=" + cpCore.db.encodeSQLText(RecordName)))));
                                                        if (isDataTableOk(rs)) {
                                                    ...
                                                    //    Verify Library Folder records
                                                    // 
                                                    VerifyLibraryFileTypes(((coreClass)(cpCore)));
                                                    try {
                                                        // 
                                                    ...
                                                    // =========================================================================================
                                                    // 
                                                    VerifyState(((coreClass)(cpcore)), ((string)(Name)), ((string)(Abbreviation)), ((double)(SaleTax)), ((int)(CountryID)), ((string)(FIPSState)));
                                                    try {
                                                        // 
                                                        int CS;
                                                        const object ContentName = "States";
                                                    ...
                                                    try {
                                                        ...
                                                        // 
                                                        VerifyState(cpCore, "Alaska", "AK", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Alabama", "AL", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Arizona", "AZ", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Arkansas", "AR", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "California", "CA", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Connecticut", "CT", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Colorado", "CO", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Delaware", "DE", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "District of Columbia", "DC", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Florida", "FL", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Georgia", "GA", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Hawaii", "HI", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Idaho", "ID", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Illinois", "IL", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Indiana", "IN", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Iowa", "IA", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Kansas", "KS", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Kentucky", "KY", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Louisiana", "LA", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Massachusetts", "MA", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Maine", "ME", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Maryland", "MD", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Michigan", "MI", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Minnesota", "MN", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Missouri", "MO", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Mississippi", "MS", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Montana", "MT", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "North Carolina", "NC", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Nebraska", "NE", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "New Hampshire", "NH", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "New Mexico", "NM", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "New Jersey", "NJ", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "New York", "NY", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Nevada", "NV", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "North Dakota", "ND", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Ohio", "OH", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Oklahoma", "OK", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Oregon", "OR", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Pennsylvania", "PA", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Rhode Island", "RI", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "South Carolina", "SC", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "South Dakota", "SD", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Tennessee", "TN", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Texas", "TX", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Utah", "UT", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Vermont", "VT", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Virginia", "VA", 0.045, CountryID, "");
                                                        VerifyState(cpCore, "Washington", "WA", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Wisconsin", "WI", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "West Virginia", "WV", 0, #, CountryID, "");
                                                        VerifyState(cpCore, "Wyoming", "WY", 0, #, CountryID, "");
                                                    }
                                                    catch (Exception ex) {
                                                        cpCore.handleException(ex);
                                                        throw;
                                                    ...
                                                    //  Get the Menu for FormInputHTML
                                                    // 
                                                    VerifyCountry(((coreClass)(cpCore)), ((string)(Name)), ((string)(Abbreviation)));
                                                    try {
                                                        int CS;
                                                        // 
                                                    ...
                                                    // =========================================================================================
                                                    // 
                                                    VerifyCountries(((coreClass)(cpCore)));
                                                    try {
                                                        // 
                                                        string list;
                                                        string[] Rows;
                                                        ...
                                                        Rows = list.Split("\r\n");
                                                        for (RowPtr = 0; (RowPtr <= UBound(Rows)); RowPtr++) {
                                                            Row = Rows[RowPtr];
                                                            if ((Row != "")) {
                                                                Attr = Row.Split(";");
                                                                if ((UBound(Attr) >= 1)) {
                                                    ...
                                                    // =========================================================================================
                                                    // 
                                                    VerifyDefaultGroups(((coreClass)(cpCore)));
                                                    try {
                                                        // 
                                                        int GroupID;
                                                        string SQL;
                                                        ...
                                                        SQL = ("Update ccContent Set EditorGroupID=" 
                                                                    + (cpCore.db.encodeSQLNumber(GroupID) + " where EditorGroupID is null;"));
                                                        cpCore.db.executeQuery(SQL);
                                                    }
                                                    catch (Exception ex) {
                                                        cpCore.handleException(ex);
                                                    ...
                                                    // ===================================================================================================================
                                                    // 
                                                    VerifyBasicTables(((coreClass)(cpCore)));
                                                    try {
                                                        // 
                                                        if (!false) {
                                                            ...
                                                            cpCore.db.createSQLTableField("Default", "ccFields", "HelpMessage", FieldTypeIdLongText);
                                                            //  deprecated but Im chicken to remove this
                                                    ...
                                                    // ===========================================================================
                                                    // 
                                                    handleClassException(((coreClass)(cpCore)), ((Exception)(ex)), ((string)(ApplicationName)), ((string)(MethodName)));
                                                    logController.appendLog(cpCore, ("exception in builderClass." 
                                                    ...
                                                    // ===========================================================================
                                                    // 
                                                    appendUpgradeLog(((coreClass)(cpCore)), ((string)(appName)), ((string)(Method)), ((string)(Message)));
                                                    logController.appendInstallLog(cpCore, ("app [" 
                                                                    + (appName + ("], Method [" 
                                                                    + (Method + ("], Message [" 
                                                                    + (Message + "]")))))));
                                                    // 
                                                    ...
                                                    // =============================================================================
                                                    // 
                                                    appendUpgradeLogAddStep(((coreClass)(cpCore)), ((string)(appName)), ((string)(Method)), ((string)(Message)));
                                                    ...
                                                    // =====================================================================================================
                                                    // 
                                                    SetNameValueArrays(((coreClass)(cpCore)), ((string)(InputName)), ((string)(InputValue)), ref ((string)(SQLName())), ref ((string)(SQLValue())), ref ((int)(Index)));
                                                    ...
                                                    // =============================================================================
                                                    // 
                                                    ((int)(verifyNavigatorEntry(((coreClass)(cpCore)), ((string)(ccGuid)), ((string)(menuNameSpace)), ((string)(EntryName)), ((string)(ContentName)), ((string)(LinkPage)), ((string)(SortOrder)), ((bool)(AdminOnly)), ((bool)(DeveloperOnly)), ((bool)(NewWindow)), ((bool)(Active)), ((string)(AddonName)), ((string)(NavIconType)), ((string)(NavIconTitle)), ((int)(InstalledByCollectionID)))));
                                                    int returnEntry = 0;
                                                    try {
                                                        if (!string.IsNullOrEmpty(EntryName.Trim())) {
                                                            ...
                                                            string listCriteria = ("(name=" 
                                                                        + (cpCore.db.encodeSQLText(EntryName) + (")and(Parentid=" 
                                                                        + (parentId + ")"))));
                                                            List<Models.Entity.NavigatorEntryModel> entryList = Models.Entity.NavigatorEntryModel.createList(cpCore, listCriteria, "id");
                                                            Models.Entity.NavigatorEntryModel entry;
