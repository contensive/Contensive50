...
//        /// <returns></returns>
//        public static visitorModelx add(coreClass cpCore, ref List<string> cacheNameList) {
...
//            return result;
//        }
//        public static visitorModelx add(coreClass cpCore) { var tmpList = new List<string> { }; return add(cpCore, ref tmpList); }
//        //
//        //====================================================================================================
//        /// <summary>
...
//        public static visitorModelx create(coreClass cpCore, int recordId, ref List<string> cacheNameList) {
//            visitorModelx result = null;
//            try {
//                if (recordId > 0) {
//                    string cacheName = Controllers.cacheController.getCacheKey_Entity(primaryContentTableName, recordId);
//                    result = cpCore.cache.getObject<visitorModelx>(cacheName);
//                    if (result == null) {
...
//            return result;
//        }
//        public static visitorModelx create(coreClass cpCore, int recordId) { var tmpList = new List<string> { }; return create(cpCore, recordId, ref tmpList); }
//        //
//        //====================================================================================================
//        /// <summary>
...
//        public static visitorModelx create(coreClass cpCore, string recordGuid, ref List<string> cacheNameList) {
//            visitorModelx result = null;
//            try {
...
//        private static visitorModelx loadObject(coreClass cpCore, string sqlCriteria, ref List<string> callersCacheNameList) {
//            visitorModelx result = null;
//            try {
...
//        /// <returns></returns>
//        public static List<visitorModelx> getObjectList(coreClass cpCore, int someCriteria) {
...
//                    do {
//                        instance = visitorModelx.create(cpCore, cs.getInteger("id"), ref ignoreCacheNames);
//                        if (instance != null) {
//                            result.Add(instance);
//                        }
//                        cs.goNext();
...
//        //====================================================================================================
//        //
//        public static visitorModelx getDefault(coreClass cpcore) {
