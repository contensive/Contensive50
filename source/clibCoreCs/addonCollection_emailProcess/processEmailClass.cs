...
//INSTANT C# TODO TASK: Calls to the VB 'Err' function are not converted by Instant C#:
					logController.appendLogWithLegacyRow(cpCore, "server", "KernelService nothing after new KernelServicesClass", "App.EXEName", "ProcessEmailClass", "ProcessEmail", Microsoft.VisualBasic.Information.Err().Number, Microsoft.VisualBasic.Information.Err().Source, Microsoft.VisualBasic.Information.Err().Description, false, true, "", "", "");
				}
				else
				{
