...
namespace Contensive.Core.Controllers
{
	...
	public class groupController : IDisposable
	{
		...
		// Add User
		//
		public static void group_addUser(coreClass cpCore, int groupId, int userid = 0, DateTime dateExpires = Convert.ToDateTime("12:00:00 AM"))
		{
			try
			{
				//
		...
		//====================================================================================================
		//
		public static void group_AddUser(coreClass cpCore, string groupNameOrGuid, int userid = 0, DateTime dateExpires = Convert.ToDateTime("12:00:00 AM"))
		{
			try
			{
				//
