	...
	public class adminUIController
	{
		...
		public string GetTitleBar(string Title, string Description)
		{
			...
			try
			{
				...
				Copy = Description;
				if (genericController.vbInstr(1, Copy, "<p>", Microsoft.VisualBasic.Constants.vbTextCompare) == 1)
				{
					Copy = Copy.Substring(3);
					if (Copy.LastIndexOf("</p>", () - 1, System.StringComparison.OrdinalIgnoreCase) + 1 == (Copy.Length - 4))
					{
...
ErrorTrap:
			handleLegacyClassError("GetHeader");
		}
		//
		//
		//
...
ErrorTrap:
			handleLegacyClassError("GetButtonsFromList");
		}
		//
		//
		//
...
ErrorTrap:
			handleLegacyClassError("GetEditSubheadRow");
		}
		//
		//========================================================================
		// GetEditPanel
		...
		private string GetReport_CellHeader(int ColumnPtr, string Title, string Width, string Align, string ClassStyle, string RefreshQueryString, SortingStateEnum SortingState)
		{
			try
			{
				...
				{
					WidthTest = genericController.EncodeInteger(Microsoft.VisualBasic.Strings.Replace(Width, "px", "", Microsoft.VisualBasic.Constants.vbTextCompare, -1, Microsoft.VisualBasic.CompareMethod.Binary));
					if (WidthTest != 0)
					{
...
ErrorTrap:
			handleLegacyClassError("GetReport");
		}
