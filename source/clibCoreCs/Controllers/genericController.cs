...
//ORIGINAL LINE: Public Shared Function getGUID(Optional ByRef registryFormat As Boolean = False) As String
		...
		public static string GetGMTFromDate(DateTime DateValue)
		{
			...
			{
				switch (Microsoft.VisualBasic.DateAndTime.Weekday(DateValue, Microsoft.VisualBasic.FirstDayOfWeek.Sunday))
				{
					case Microsoft.VisualBasic.Constants.vbSunday:
						tempGetGMTFromDate = "Sun, ";
						break;
					case Microsoft.VisualBasic.Constants.vbMonday:
						tempGetGMTFromDate = "Mon, ";
						break;
					case Microsoft.VisualBasic.Constants.vbTuesday:
						tempGetGMTFromDate = "Tue, ";
						break;
					case Microsoft.VisualBasic.Constants.vbWednesday:
						tempGetGMTFromDate = "Wed, ";
						break;
					case Microsoft.VisualBasic.Constants.vbThursday:
						tempGetGMTFromDate = "Thu, ";
						break;
					case Microsoft.VisualBasic.Constants.vbFriday:
						tempGetGMTFromDate = "Fri, ";
						break;
					case Microsoft.VisualBasic.Constants.vbSaturday:
		...
		//    '
		//    '
		public static string GetApplicationStatusMessage(Models.Entity.serverConfigModel.appStatusEnum ApplicationStatus)
		{
		...
		public static string ConvertLinksToAbsolute(string Source, string RootLink)
		{
			...
			try
			{
				result = vbReplace(result, " href=\"", " href=\"/", 1, 99, Microsoft.VisualBasic.Constants.vbTextCompare);
				result = vbReplace(result, " href=\"/http", " href=\"http", 1, 99, Microsoft.VisualBasic.Constants.vbTextCompare);
				result = vbReplace(result, " href=\"/mailto", " href=\"mailto", 1, 99, Microsoft.VisualBasic.Constants.vbTextCompare);
				result = vbReplace(result, " href=\"//", " href=\"" + RootLink, 1, 99, Microsoft.VisualBasic.Constants.vbTextCompare);
				result = vbReplace(result, " href=\"/?", " href=\"" + RootLink + "?", 1, 99, Microsoft.VisualBasic.Constants.vbTextCompare);
				result = vbReplace(result, " href=\"/", " href=\"" + RootLink, 1, 99, Microsoft.VisualBasic.Constants.vbTextCompare);
				//
				result = vbReplace(result, " href=", " href=/", 1, 99, Microsoft.VisualBasic.Constants.vbTextCompare);
				...
				result = vbReplace(result, " href=/", " href=" + RootLink, 1, 99, Microsoft.VisualBasic.Constants.vbTextCompare);
				//
				result = vbReplace(result, " src=\"", " src=\"/", 1, 99, Microsoft.VisualBasic.Constants.vbTextCompare);
				result = vbReplace(result, " src=\"/http", " src=\"http", 1, 99, Microsoft.VisualBasic.Constants.vbTextCompare);
				result = vbReplace(result, " src=\"//", " src=\"" + RootLink, 1, 99, Microsoft.VisualBasic.Constants.vbTextCompare);
				result = vbReplace(result, " src=\"/?", " src=\"" + RootLink + "?", 1, 99, Microsoft.VisualBasic.Constants.vbTextCompare);
				result = vbReplace(result, " src=\"/", " src=\"" + RootLink, 1, 99, Microsoft.VisualBasic.Constants.vbTextCompare);
				//
				result = vbReplace(result, " src=", " src=/", 1, 99, Microsoft.VisualBasic.Constants.vbTextCompare);
...
//INSTANT C# TODO TASK: Calls to the VB 'Err' function are not converted by Instant C#:
				...
				{
//INSTANT C# TODO TASK: Calls to the VB 'Err' function are not converted by Instant C#:
					Copy = Microsoft.VisualBasic.Information.Err().Description;
					Copy = vbReplace(Copy, Environment.NewLine, "-");
					Copy = vbReplace(Copy, "\n", "-");
					Copy = vbReplace(Copy, Environment.NewLine, "");
//INSTANT C# TODO TASK: Calls to the VB 'Err' function are not converted by Instant C#:
					tempGetErrString = "[" + Microsoft.VisualBasic.Information.Err().Source + " #" + Microsoft.VisualBasic.Information.Err().Number + ", " + Copy + "]";
				}
			}
			else
			{
...
return tempgetSimpleNameValue;
		...
		{
			int returnSeconds = 0;
			object oldDate = new DateTime(1900, 1, 1);
		...
		{
			if (Diagnostics.Process.GetProcessesByName(Diagnostics.Process.GetCurrentProcess.ProcessName).GetUpperBound(0) > 0)
			{
				return true;
			}
			else
