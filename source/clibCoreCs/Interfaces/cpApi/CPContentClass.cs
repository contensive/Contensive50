...
namespace Contensive.Core
{
	...
	//
	[ComVisible(true), Microsoft.VisualBasic.ComClass(CPContentClass.ClassId, CPContentClass.InterfaceId, CPContentClass.EventsId)]
...
#region COM GUIDs
		...
		{
			return Models.Complex.cdefModel.addContent(cpCore, true, Models.Entity.dataSourceModel.create(cpCore, dataSourceName, new List<string>()), sqlTableName, ContentName, false, false, true, false, "", "sort order", "name", false, false, false, false, false, false, "", 0, 0, 0, "", false, "", true);
		}
		//
		//====================================================================================================
		//
