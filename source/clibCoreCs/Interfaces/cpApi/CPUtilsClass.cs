...
namespace Contensive.Core
{
	...
	//
	[ComVisible(true), Microsoft.VisualBasic.ComClass(CPUtilsClass.ClassId, CPUtilsClass.InterfaceId, CPUtilsClass.EventsId)]
...
#region COM GUIDs
		...
		//
		public CPUtilsClass(ref CPClass CPParentObj) : base()
		{
			CP = CPParentObj;
		}
		//
		...
		{
			return genericController.getLine(Body);
		}
		...
		{
			genericController.ParseURL(SourceURL, Protocol, Host, Port, Path, Page, QueryString);
		}
		...
		{
			genericController.SeparateURL(SourceURL, Protocol, Host, Path, Page, QueryString);
		}
		...
		public override int installCollectionFromFile(string privateFile)
		{
			...
			string ignoreGuid = "";
			addonInstallClass.InstallCollectionsFromPrivateFile(CP.core, privateFile, ignoreUserMessage, ignoreGuid, false, new List<string>());
			return taskId;
		}
		//
		//====================================================================================================
		...
		public override int installCollectionsFromFolder(string privateFolder, bool deleteFolderWhenDone)
		{
			...
			addonInstallClass.InstallCollectionsFromPrivateFolder(CP.core, privateFolder, ignoreUserMessage, ignoreList, false, new List<string>());
			return taskId;
		}
		//
		//====================================================================================================
		...
		public override int installCollectionFromLibrary(string collectionGuid)
		{
			int taskId = 0;
			string ignoreUserMessage = "";
			addonInstallClass.installCollectionFromRemoteRepo(CP.core, collectionGuid, ignoreUserMessage, "", false, new List<string>());
			return taskId;
		}
		//
		//====================================================================================================
