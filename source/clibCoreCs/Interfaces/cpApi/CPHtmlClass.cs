...
namespace Contensive.Core
{
	...
	//
	[ComVisible(true), Microsoft.VisualBasic.ComClass(CPHtmlClass.ClassId, CPHtmlClass.InterfaceId, CPHtmlClass.EventsId)]
...
#region COM GUIDs
		...
		// Constructor
		//
		public CPHtmlClass(ref CPClass cpParent) : base()
		{
			cp = cpParent;
			cpCore = cp.core;
		}
		...
		public override void ProcessInputFile(string HtmlName, string VirtualFilePath = "") //Inherits BaseClasses.CPHtmlBaseClass.ProcessInputFile
		{
			...
			cpCore.cdnFiles.upload(HtmlName, VirtualFilePath, ignoreFilename);
		}
		//'
		//'====================================================================================================
		//''' <summary>
