...
namespace Contensive.Core
{
	public class coreClass : IDisposable
	{
		...
		public Models.Entity.serverConfigModel serverConfig {get; set;}
		//
		//===================================================================================================
		/// <summary>
		...
		//
		//===================================================================================================
		public Dictionary<string, Models.Entity.dataSourceModel> dataSourceDictionary
		{
			get
			{
				if (_dataSources == null)
				{
					_dataSources = Models.Entity.dataSourceModel.getNameDict(this);
				}
				return _dataSources;
			}
		}
		private Dictionary<string, Models.Entity.dataSourceModel> _dataSources = null;
		//
		//===================================================================================================
		...
		/// <returns></returns>
		/// <remarks></remarks>
		public Models.Entity.domainLegacyModel domainLegacyCache
		{
			get
			{
				if (_domains == null)
				{
					_domains = new Models.Entity.domainLegacyModel(this);
				}
				return _domains;
			}
		}
		private Models.Entity.domainLegacyModel _domains = null;
		//
		//===================================================================================================
		...
		public coreClass(CPClass cp) : base()
		{
			...
			//
			serverConfig = Models.Entity.serverConfigModel.getObject(this);
			this.serverConfig.defaultDataSourceType = Models.Entity.dataSourceModel.dataSourceTypeEnum.sqlServerNative;
		...
		/// <param name="cp"></param>
		/// <remarks></remarks>
		public coreClass(CPClass cp, Models.Entity.serverConfigModel serverConfig) : base()
		{
			...
			this.serverConfig.defaultDataSourceType = Models.Entity.dataSourceModel.dataSourceTypeEnum.sqlServerNative;
			this.serverConfig.appConfig.appStatus = Models.Entity.serverConfigModel.appStatusEnum.OK;
			webServer.iisContext = null;
			constructorInitialize();
		}
		//
		...
		/// <param name="cp"></param>
		/// <remarks></remarks>
		public coreClass(CPClass cp, Models.Entity.serverConfigModel serverConfig, System.Web.HttpContext httpContext) : base()
		{
			this.cp_forAddonExecutionOnly = cp;
			//
			// -- create default auth objects for non-user methods, or until auth is available
		...
		public coreClass(CPClass cp, string applicationName) : base()
		{
			...
			doc.authContext = new authContextModel(this);
			//
			serverConfig = Models.Entity.serverConfigModel.getObject(this, applicationName);
					...
					if (routeFound)
					{
						...
						switch (route.routeType)
						{
							...
							case CPSiteBaseClass.routeTypeEnum.linkForward:
								//
								// -- link forward
								Models.Entity.linkForwardModel linkForward = Models.Entity.linkForwardModel.create(this, route.linkForwardId);
						...
						switch (genericController.vbLCase(RemoteKey))
						{
							case "ccfieldhelpupdate":
								...
								if (!doc.authContext.user.Developer)
								{
									...
									int Ptr = 0;
									if (Microsoft.VisualBasic.Information.IsArray(gv.errors))
									{
...
//INSTANT C# TODO TASK: The following 'ReDim' could not be resolved. A possible reason may be that the object of the ReDim was not declared as an array:
					...
					if (gv.status == GoogleVisualizationStatusEnum.OK)
					{
						switch (QueryType)
						{
							case QueryTypeUpdateContent:
								...
								SetPairString = "";
								Criteria = "";
								for (var Ptr = 0; Ptr < ArgName.Count(); Ptr++)
								{
		...
		private void constructorInitialize()
		{
			try
			{
				...
				else if ((serverConfig.appConfig.appMode != Models.Entity.serverConfigModel.appModeEnum.normal) | (serverConfig.appConfig.appStatus != Models.Entity.serverConfigModel.appStatusEnum.OK))
				{
					//
