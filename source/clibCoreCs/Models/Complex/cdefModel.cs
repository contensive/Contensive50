...
//ORIGINAL LINE: Public Property childIdList(cpCore As coreClass) As List(Of Integer)
			...
			try
			{
				...
				if (result == null)
				{
					...
					else
					{
						...
						result.Id = contentId;
						result.AllowAdd = genericController.EncodeBoolean(row.Item(3));
						result.DeveloperOnly = genericController.EncodeBoolean(row.Item(4));
						result.AdminOnly = genericController.EncodeBoolean(row.Item(5));
						result.AllowDelete = genericController.EncodeBoolean(row.Item(6));
						result.parentID = genericController.EncodeInteger(row.Item(7));
						result.DropDownFieldList = genericController.vbUCase(genericController.encodeText(row.Item(9)));
						result.ContentTableName = genericController.encodeText(contentTablename);
						result.ContentDataSourceName = "default";
						result.AllowCalendarEvents = genericController.EncodeBoolean(row.Item(15));
						result.DefaultSortMethod = genericController.encodeText(row.Item(17));
						if (string.IsNullOrEmpty(result.DefaultSortMethod))
						{
							result.DefaultSortMethod = "name";
						}
						result.EditorGroupName = genericController.encodeText(row.Item(18));
						result.AllowContentTracking = genericController.EncodeBoolean(row.Item(19));
						result.AllowTopicRules = genericController.EncodeBoolean(row.Item(20));
						...
						else
						{
							...
							{
									row = rowWithinLoop;
								string fieldName = genericController.encodeText(rowWithinLoop.Item(13));
								int fieldId = genericController.EncodeInteger(rowWithinLoop.Item(12));
								...
								if (!skipDuplicateField)
								{
									...
									int fieldTypeId = genericController.EncodeInteger(rowWithinLoop.Item(15));
									if (genericController.encodeText(rowWithinLoop.Item(4)) != "")
									{
										fieldIndexColumn = genericController.EncodeInteger(rowWithinLoop.Item(4));
									}
									//
									// translate htmlContent to fieldtypehtml
									//   this is also converted in upgrade, daily housekeep, addon install
									//
									bool fieldHtmlContent = genericController.EncodeBoolean(rowWithinLoop.Item(25));
									if (fieldHtmlContent)
									{
									...
									field.active = genericController.EncodeBoolean(rowWithinLoop.Item(24));
									field.adminOnly = genericController.EncodeBoolean(rowWithinLoop.Item(8));
									field.authorable = genericController.EncodeBoolean(rowWithinLoop.Item(27));
									field.blockAccess = genericController.EncodeBoolean(rowWithinLoop.Item(38));
									field.caption = genericController.encodeText(rowWithinLoop.Item(16));
									field.dataChanged = false;
									//.Changed
									field.contentId = contentId;
									field.defaultValue = genericController.encodeText(rowWithinLoop.Item(22));
									field.developerOnly = genericController.EncodeBoolean(rowWithinLoop.Item(0));
									field.editSortPriority = genericController.EncodeInteger(rowWithinLoop.Item(10));
									field.editTabName = genericController.encodeText(rowWithinLoop.Item(34));
									field.fieldTypeId = fieldTypeId;
									field.htmlContent = fieldHtmlContent;
									field.id = fieldId;
									field.indexColumn = fieldIndexColumn;
									field.indexSortDirection = genericController.EncodeInteger(rowWithinLoop.Item(7));
									field.indexSortOrder = genericController.EncodeInteger(rowWithinLoop.Item(6));
									field.indexWidth = genericController.encodeText(genericController.EncodeInteger(genericController.encodeText(rowWithinLoop.Item(5)).Replace("%", "")));
									field.inherited = false;
									field.installedByCollectionGuid = genericController.encodeText(rowWithinLoop.Item(39));
									field.isBaseField = genericController.EncodeBoolean(rowWithinLoop.Item(38));
									field.isModifiedSinceInstalled = false;
									field.lookupContentID = genericController.EncodeInteger(rowWithinLoop.Item(18));
									//.lookupContentName = ""
									field.lookupList = genericController.encodeText(rowWithinLoop.Item(37));
									field.manyToManyContentID = genericController.EncodeInteger(rowWithinLoop.Item(28));
									field.manyToManyRuleContentID = genericController.EncodeInteger(rowWithinLoop.Item(29));
									field.ManyToManyRulePrimaryField = genericController.encodeText(rowWithinLoop.Item(30));
									field.ManyToManyRuleSecondaryField = genericController.encodeText(rowWithinLoop.Item(31));
									//.ManyToManyContentName(cpCore) = ""
									//.ManyToManyRuleContentName(cpCore) = ""
									field.MemberSelectGroupID = genericController.EncodeInteger(rowWithinLoop.Item(36));
									//.MemberSelectGroupName(cpCore) = ""
									field.nameLc = fieldNameLower;
									field.NotEditable = genericController.EncodeBoolean(rowWithinLoop.Item(26));
									field.Password = genericController.EncodeBoolean(rowWithinLoop.Item(3));
									field.ReadOnly = genericController.EncodeBoolean(rowWithinLoop.Item(17));
									field.RedirectContentID = genericController.EncodeInteger(rowWithinLoop.Item(19));
									//.RedirectContentName(cpCore) = ""
									field.RedirectID = genericController.encodeText(rowWithinLoop.Item(21));
									field.RedirectPath = genericController.encodeText(rowWithinLoop.Item(20));
									field.Required = genericController.EncodeBoolean(rowWithinLoop.Item(14));
									field.RSSTitleField = genericController.EncodeBoolean(rowWithinLoop.Item(32));
									field.RSSDescriptionField = genericController.EncodeBoolean(rowWithinLoop.Item(33));
									field.Scramble = genericController.EncodeBoolean(rowWithinLoop.Item(35));
									field.TextBuffered = genericController.EncodeBoolean(rowWithinLoop.Item(2));
									field.UniqueName = genericController.EncodeBoolean(rowWithinLoop.Item(1));
									//.ValueVariant
									//
									field.HelpCustom = genericController.encodeText(rowWithinLoop.Item(41));
									field.HelpDefault = genericController.encodeText(rowWithinLoop.Item(40));
		...
		public static List<int> getEditableCdefIdList(coreClass cpcore)
		{
			...
			try
			{
				...
				+ " WHERE"
					+ " (ccMemberRules.MemberID=" + cpcore.doc.authContext.user.id + ")"
		...
		public static void setCache(coreClass cpcore, int contentId, cdefModel cdef)
		{
			...
			cpcore.cache.setContent(cacheName, cdef, dependantList);
		}
		//
		//====================================================================================================
		//
