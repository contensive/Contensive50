...
namespace Contensive.Core.Models.Entity {
    public class visitModel {
        ...
        public static visitModel add(coreClass cpCore) { var tmpList = new List<string> { }; return add(cpCore, ref tmpList); }
        //
        //====================================================================================================
        /// <summary>
        ...
        public static List<visitModel> getObjectList(coreClass cpCore, int someCriteria) {
            ...
            try {
                ...
                if (cs.open(primaryContentName, "(someCriteria=" + someCriteria + ")", "name", true, "id")) {
                    ...
                    do {
                        instance = visitModel.create(cpCore, cs.getInteger("id"), ref ignoreCacheNames);
                        if (instance != null) {
                            result.Add(instance);
                        }
                        cs.goNext();
