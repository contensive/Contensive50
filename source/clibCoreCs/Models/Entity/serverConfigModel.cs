...
namespace Contensive.Core.Models.Entity
{
	...
	public class serverConfigModel
	{
		...
		public Models.Entity.dataSourceModel.dataSourceTypeEnum defaultDataSourceType;
		...
		public static Models.Entity.serverConfigModel getObject(coreClass cpCore)
		{
			Models.Entity.serverConfigModel returnModel = null;
			try
			{
		...
		/// <param name="cp"></param>
		/// <param name="recordId"></param>
		public static Models.Entity.serverConfigModel getObject(coreClass cpCore, string appName)
		{
			Models.Entity.serverConfigModel returnModel = null;
			try
			{
